...
public interface IEditorDescriptor extends IWorkbenchPartDescriptor {
	 ...
	 * <p>
	 * For internal editors, this is the extension id as defined in the
	 * workbench registry; for external editors, it is path and file name of the
	 * external program.
	 * </p>
	 * 
	...
	/**
	 * Returns whether this editor descriptor will open a regular editor part
	...
	/**
	 * Returns whether this editor descriptor will open an external editor in a
	 * new window outside the workbench.
	 * 
	...
	/**
	 * Returns the editor matching strategy object for editors represented by
	 * this editor descriptor, or <code>null</code> if there is no explicit
	 * matching strategy specified.
	 * 
