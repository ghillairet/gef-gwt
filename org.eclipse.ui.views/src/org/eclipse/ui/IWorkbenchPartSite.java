...
public interface IWorkbenchPartSite extends IWorkbenchSite {
	 ...
	 * the target part must publish each menu by calling
	 * <code>registerContextMenu</code>. Once this has been done the workbench
	 * will automatically insert any action extensions which exist.
	 * </p>
	 * <p>
	 * A menu id must be provided for each registered menu. For consistency
	 * across parts the following strategy should be adopted by all part
	 * implementors.
	 * </p>
	 * <ol>
	 ...
	 * <code>IWorkbenchActionConstants.MB_ADDITIONS</code>. Other plug-ins will
	 * use this group as a reference point for insertion. The marker should be
	 * defined at an appropriate location within the menu for insertion.
	 * </p>
	 * 
	 * @param menuManager
	 *            the menu manager
