...
public interface IEditorPart extends IWorkbenchPart, ISaveablePart {
	 ...
	 * <code>null</code> for the remainder of the editor's life cycle.
	 * </p>
	 * 
	 * @return the editor site; this value may be <code>null</code> if the
	 ...
	 * instantiated. It marks the start of the part's lifecycle. The
	 * {@link IWorkbenchPart#dispose IWorkbenchPart.dispose} method will be
	 * called automically at the end of the lifecycle. Clients must not call
	 * this method.
	 * </p>
	 * <p>
