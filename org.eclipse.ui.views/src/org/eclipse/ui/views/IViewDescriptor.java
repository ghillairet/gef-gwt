...
public interface IViewDescriptor extends IWorkbenchPartDescriptor, IAdaptable {
	 ...
	 *             thrown if there is a problem creating the part
	 */
	public IViewPart createView() throws CoreException;

	/**
	 * Returns an array of strings that represent view's category path. This
	 * array will be used for hierarchical presentation of the view in places
	 * like submenus.
	 * 
