 ...
 * <code>PropertySheetPage</code>. Note that in the latter case, the client will
 * also need to register a suitable adapter factory with the platform's adapter
 * manager (<code>Platform.getAdapterManager</code>).
 * </p>
 * 
