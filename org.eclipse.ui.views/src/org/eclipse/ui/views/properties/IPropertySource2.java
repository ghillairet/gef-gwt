 ...
 * <p>
 * This interface provides extended API to <code>IPropertySource</code> to allow
 * an easier indication of properties that have a default value and can be
 * resetted.
 * </p>
 * 
 * @since 3.0
...
public interface IPropertySource2 extends IPropertySource {
	 ...
	 * <code>IPropertySource</code> method to return <code>true</code> instead
	 * of <code>false</code> if the specified property does not have a
	 * meaningful default value. <code>isPropertyResettable</code> will only be
	 * called if <code>isPropertySet</code> returns <code>true</code>.
	 * <p>
