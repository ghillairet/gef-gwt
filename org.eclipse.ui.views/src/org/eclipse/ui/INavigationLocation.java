...
public interface INavigationLocation {
	 ...
	 * saved by the previous call of saveState(IMemento). This object will not
	 * be used until restoreState is called again.
	 */
	...
	/**
	 * Merge the receiver into <code>currentLocation</code>. Return true if the
	 * two locations could be merged otherwise return false.
	 * <p>
	...
	/**
	 * Returns the input used for this location. Returns <code>null</code> if
	 * the receiver's state has been released.
	 * 
