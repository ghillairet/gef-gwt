...
public interface ISelectionService {
	 ...
	 * </p>
	 * <p>
	 * Note: This will not correctly track editor parts as each editor does not
	 * have a unique partId.
	 * </p>
	 * <p>
	 * <b>Note:</b> listeners should be removed when no longer necessary. If
	 * not, they will be removed when the IServiceLocator used to acquire this
	...
	/**
	 * Returns the current selection in the part with the given id. If the part
	 * is not open, or if the selection in the active part is <em>undefined</em>
