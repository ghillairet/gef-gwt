...
public interface ICommandService extends IDisposable {
	 ...
	 * exception, but the value of the parameter when the command is executed
	 ...
	 *            a <code>String</code> representing a command id and parameter
	 *            ids and values
	 ...
	 * 
	 * @return The collection of category identifiers (<code>String</code>) that
	 ...
	 * in the workbench.
	 * 
	 * @return The collection of command identifiers (<code>String</code>) that
	 *         are defined; never <code>null</code>, but may be empty.
	 */
	 ...
	 *         <code>String</code>) that are defined; never <code>null</code>,
	 *         but may be empty.
	 * @since 3.2
	 */
	 ...
	 * they will be removed when the IServiceLocator used to acquire this
	 * service is disposed.
	 * </p>
	 * 
	 * @param command
	 ...
	 * allows the active handler the opportunity to provide user feedback. If
