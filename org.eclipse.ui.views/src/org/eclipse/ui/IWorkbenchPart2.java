...
public interface IWorkbenchPart2 extends IWorkbenchPart {
	 ...
	 * {@link IWorkbenchPartConstants#PROP_PART_NAME}.
	 * 
	...
	/**
	 * Returns the content description of this part. The content description is
	 * an optional user-readable string that describes what is currently being
	 ...
	 * indicates no content description text. If this value changes the part
	 * must fire a property listener event with
