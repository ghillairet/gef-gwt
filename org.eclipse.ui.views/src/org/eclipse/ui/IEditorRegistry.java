...
public interface IEditorRegistry {
	 ...
	 * an input which implements {@link org.eclipse.ui.IPathEditorInput
	 * IPathEditorInput}. Use {@link #findEditor findEditor} to access the
	 * editor descriptor for this identifier.
	 * 
	 * @since 3.0
	 */
	 ...
	 * is only present in the registry on platforms that support in-place
	 * editing (for example Win32). This editor requires an input which
	 * implements {@link org.eclipse.ui.IInPlaceEditorInput IInPlaceEditorInput}
	...
	/**
	 * Adds a listener for changes to properties of this registry. Has no effect
	 * if an identical listener is already registered.
	 * <p>
	 * The properties ids are as follows:
	 * <ul>
	 * <li><code>PROP_CONTENTS</code>: Triggered when the file editor mappings
	 * in the editor registry change.</li>
	 * </ul>
	 * </p>
	 * 
	 * @param listener
	 ...
	 * @param editorId
	 *            the editor id
	 * @return the editor descriptor with the given id, or <code>null</code> if
	 *         not found
	 */
	...
	/**
	 * Returns the default editor for a given file name and with the given
	 * content type.
	 * <p>
	 * The default editor is determined by taking the file extension for the
	 * file and obtaining the default editor for that extension.
	 ...
	 *            the file name in the system
	 * @param contentType
	 *            the content type or <code>null</code> for the unknown content
	 *            type
	 * @return the descriptor of the default editor, or <code>null</code> if not
	 *         found
	 * @since 3.1
	 ...
	 * available for that type. The set of editors includes those registered via
	 * plug-ins and those explicitly associated with a type by the user in the
	 * workbench preference pages.
	 * </p>
	 * 
	...
	/**
	 * Sets the default editor id for the files that match that specified file
	 * name or extension. The specified editor must be defined as an editor for
	 * that file name or extension.
	 * 
	 * @param fileNameOrExtension
	 *            the file name or extension pattern (e.g. "*.xml");
	 * @param editorId
	 *            the editor id or <code>null</code> for no default
	 */
	public void setDefaultEditor(String fileNameOrExtension, String editorId);

	/**
	 * Returns whether there is an in-place editor that could handle a file with
	 * the given name.
	 * 
	 * @param filename
	 *            the file name
	...
	/**
	 * Returns whether the system has an editor that could handle a file with
	 * the given name.
	 * 
	 * @param filename
	 *            the file name
	...
	/**
	 * Returns the image descriptor associated with the system editor that would
	 * be used to edit this file externally.
	 * 
	 * @param filename
	 *            the file name
