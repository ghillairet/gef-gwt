...
public interface IWorkingSetManager {
	...
	/**
	 * Change event id when a working set updater got uninstalled. NewValue will
	 * be <code>null</code> OldValue of the PropertyChangeEvent will be the
	 * uninstalled updater.
	 * 
	 * @since 3.3
	 */
	...
	/**
	 * Adds a working set to the top of the list of most recently used working
	 * sets, making it the most recently used working set. The last (oldest)
	 * item will be deleted if the list exceeds the size limit.
	 * 
	 * @param workingSet
	 *            the working set to add to the list of most recently used
	 *            working sets.
	 */
	...
	/**
	 * Creates a new working set. The working set is not added to the working
	 * set manager.
	 * 
	 * @param name
	...
	/**
	 * Returns the list of most recently used working sets. The most recently
	 * used working set appears first in the list.
	 * 
	...
	/**
	 * Returns the working set with the specified name. Returns null if there is
	 * no working set with that name.
	 * 
	 * @param name
	 ...
	 * set whose {@link IWorkingSet#isVisible()} method returns false will not
	 * be included in this array. For a complete list of working sets please use
