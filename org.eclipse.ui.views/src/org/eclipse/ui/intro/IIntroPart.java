...
public interface IIntroPart extends IAdaptable {
	 ...
	 * construction. It marks the start of the intro's lifecycle. Clients must
	 ...
	 * part should be partially visible to the user but otherwise allow them to
	 * work. In full mode, the part should be fully visible and be the center of
	 ...
	 * 
	 * @param standby
	 *            <code>true</code> to put this part in its partially visible
	...
	/**
	 * Adds a listener for changes to properties of this intro part. Has no
	 ...
	 * part of an SWT composite. There is no guarantee that createPartControl()
	 * has been called, so the part controls may never have been created.
	 * </p>
	 * <p>
	...
	/**
	 * Returns the title image of this intro part. If this value changes the
	 * part must fire a property listener event with
