...
public class LabelRetargetAction extends RetargetAction {
	...
	protected void setActionHandler(IAction handler) {
		...
		if (handler == null) {
			...
			// If no text is specified by the handler, use the default text.
			// Fixes 22529.
	...
	/**
	 * Sets the tooltip text to the given text. The value <code>null</code>
	...
	/**
	 * Ensures the accelerator is correct in the text (handlers are not allowed
