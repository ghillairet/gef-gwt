 ...
 * provide an action handler then this action is disabled. </p>
 * <p>
...
public class RetargetAction extends PartEventAction implements
	...
	/*
	 * (non-Javadoc) Retaget actions do not have accelerators. It is up to the
	 ...
	 * 
	 * @param part
	 *            the workbench part that has been closed
	 */
	 ...
	 *         handler will be <code>null</code> if there is no current handler.
	 */
