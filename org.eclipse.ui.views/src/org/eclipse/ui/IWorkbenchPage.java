...
public interface IWorkbenchPage extends IPartService, ISelectionService,
	 ...
	 * <code>true</code>. The page itself is closed if <code>closePage</code> is
	 * <code>true</code>.
	 * 
	 * @param saveEditors
	 ...
	 * sets assigned to this page via {@link #setWorkingSets(IWorkingSet[])}. It
	 * is recommended that any client that uses this API be aware of this and
	 * act accordingly. Specifically, it is recommended that any client
	 * utilizing this or any other IWorkingSet whose
	 * {@link IWorkingSet#isAggregateWorkingSet()} returns <code>true</code> act
	 * as if they are not using any working set if the set is empty. These
	 * clients should also maintain an awareness of the contents of aggregate
	 * working sets and toggle this behavior should the contents of the
	 * aggregate either become empty or non-empty.
	 * </p>
	 * <p>
	 * Example: <br/>
	 * Here we have pseudocode showing how some workingset utilizing component
	 * could react to changes in aggregate working sets. <br/>
	 * <code>
	 ...
	 *            #hideEditor(IEditorReference), must not have been closed, and
