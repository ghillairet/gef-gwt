...
public final class PlatformUI {
	 ...
	 * still being initialized, so it may not be safe to call workbench API
	...
	/**
	 * Creates the workbench and associates it with the given display and
	 ...
	 * <p>
	 * This method is intended to be called by the main class (the
	 * "application"). Fails if the workbench UI has already been created.
	 * </p>
	 * <p>
	 * Use {@link #createDisplay createDisplay} to create the display to pass
	 * in.
	 * </p>
	 * <p>
	 ...
	 *         IWorkbench.restart}; {@link #RETURN_UNSTARTABLE
	 *         RETURN_UNSTARTABLE} if the workbench could not be started;
	 *         {@link #RETURN_EMERGENCY_CLOSE RETURN_EMERGENCY_CLOSE} if the UI
	 *         quit because of an emergency; other values reserved for future
	 *         use
	 * @since 3.0
	 */
	 ...
	 * caller's responsibility to dispose the resulting <code>Display</code>,
	 * not the workbench's.
	 * 
	 * @return the display
	 * @since 3.0
	 ...
	 * <p>
	 * IMPORTANT: This method is only for use by the test harness. Applications
	 * and regular plug-ins should not call this method.
	 * </p>
	 * 
