...
public final class Color extends Resource {
	...
	public boolean equals(Object object) {
		...
		return getBlue() == color.getBlue() && getRed() == color.getRed()
	...
	private GdkColor hackHandle() {
		GdkColor gdkColor = new GdkColor();
		gdkColor.red = (short) ((255 & 0xFF) | ((255 & 0xFF) << 8));
		gdkColor.green = (short) ((255 & 0xFF) | ((255 & 0xFF) << 8));
		gdkColor.blue = (short) ((255 & 0xFF) | ((255 & 0xFF) << 8));
		return gdkColor;
	}
