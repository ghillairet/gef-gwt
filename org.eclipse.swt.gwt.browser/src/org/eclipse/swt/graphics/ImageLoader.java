...
public class ImageLoader {
	...
	/**
	 * Returns <code>true</code> if the receiver has image loader listeners, and
	 * <code>false</code> otherwise.
	 * 
	 * @return <code>true</code> if there are <code>ImageLoaderListener</code>s,
	 ...
	 * 
	 * @param event
	 *            the <code>ImageLoaderEvent</code> to send to each
	 *            <code>ImageLoaderListener</code>
	 */
