 ...
 * width and height specified by setting a <code>RowData</code> object into the
 * control.
 * <p>
...
public final class RowData {
	...
	/**
	 * Constructs a new instance of RowData according to the parameter. A value
	 * of SWT.DEFAULT indicates that no minimum width or no minimum height is
	 * specified.
	 * 
	 * @param point
	 *            a point whose x coordinate specifies a minimum width for the
