 ...
 * be added to a control using the <code>addAccessibleControlListener</code>
 * method and removed using the <code>removeAccessibleControlListener</code>
 * method. When a client requests information the appropriate method will be
 * invoked.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * Note: This interface is typically used by implementors of a custom control to
...
public interface AccessibleControlListener extends SWTEventListener {
	 ...
	 * child at the specified display coordinates.
	 * <p>
	 ...
	 * or the location of a child of the control.
	 * <p>
	 ...
	 * control, or the default action of a child of the control.
	 * <p>
	 ...
	 * the role of a child of the control.
	 * <p>
	 ...
	 * the state of a child of the control.
	 * <p>
	 ...
	 * the value of a child of the control.
	 * <p>
