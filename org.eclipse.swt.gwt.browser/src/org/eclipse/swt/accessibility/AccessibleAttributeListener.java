 ...
 * AccessibleAttribute events.
 * <p>
 * After creating an instance of a class that implements this interface it can
 * be added to an accessible using the
 * <code>addAccessibleAttributeListener</code> method and removed using the
 * <code>removeAccessibleAttributeListener</code> method.
 * </p>
 * 
...
public interface AccessibleAttributeListener extends SWTEventListener {
	 ...
	 *            <li>[out] alignment - one of <code>SWT#LEFT</code>,
	 *            <code>SWT#RIGHT</code> or <code>SWT#CENTER</code></li>
	 *            <li>[out] indent - the indent in pixels</li>
	 *            <li>[out] attributes - an array of alternating key and value
	 *            Strings which represent additional (i.e. non predefined)
	 *            attributes</li>
	 *            </ul>
	 */
	 ...
	 *            an event object containing the following fields:
	 *            <ul>
	 *            <li>[in] offset - the 0 based text offset for which to return
	 *            attribute information</li>
	 *            <li>[out] start - the 0 based starting offset of the character
	 *            range over which all text attributes match those of offset</li>
	 *            <li>[out] end - the 0 based offset after the last character of
	 *            the character range over which all text attributes match those
	 *            of offset</li>
	 *            <li>[out] textStyle - the TextStyle of the character range</li>
	 *            <li>[out] attributes - an array of alternating key and value
	 *            Strings that represent additional attributes that do not
	 *            correspond to TextStyle fields</li>
	 *            </ul>
	 */
