...
public abstract class Layout {
	...
	/**
	 * Instruct the layout to flush any cached values associated with the
	 * control specified in the argument <code>control</code>.
	 * 
	 * @param control
	 *            a control managed by this layout
	 * @return true if the Layout has flushed all cached information associated
	 *         with control
	 * 
	 * @since 3.1
	 */
