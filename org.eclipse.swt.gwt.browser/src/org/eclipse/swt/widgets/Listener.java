 ...
 * <code>handleEvent()</code> method that is used internally by SWT to dispatch
 * events.
 * <p>
 * After creating an instance of a class that implements this interface it can
 * be added to a widget using the
 * <code>addListener(int eventType, Listener handler)</code> method and removed
 * using the <code>removeListener (int eventType, Listener handler)</code>
 * method. When the specified event occurs, <code>handleEvent(...)</code> will
