 ...
 * objects that occur within specific controls. For example, a tree will contain
 * tree items.
 * <dl>
 * <dt><b>Styles:</b></dt>
 * <dd>(none)</dd>
...
public abstract class Item extends Widget {
	 ...
	 * value describing its behavior and appearance. The item is added to the
	 * end of the items maintained by its parent.
	 * <p>
	 ...
	 *            be null)
	 * @param style
	 *            the style of item to construct
	 * 
	...
	/**
	 * Constructs a new instance of this class given its parent and a style
	 * value describing its behavior and appearance, and the index at which to
	 * place it in the items maintained by its parent.
	 * <p>
	 * The style value is either one of the style constants defined in class
	 * <code>SWT</code> which is applicable to instances of this class, or must
	 * be built by <em>bitwise OR</em>'ing together (that is, using the
