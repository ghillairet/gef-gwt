...
/**
 * Instances of this class are created in response to a touch-based input device
 * being touched. They are found in the <code>touches</code> field of an Event
 * or TouchEvent.
 * 
...
public final class Touch {
	 ...
	 */
	Touch(long identity, TouchSource source, int state, boolean primary, int x,
			int y) {
		this.id = identity;
		this.source = source;
		this.state = state;
	...
	public String toString() {
		return "Touch {id=" + id + " source=" + source + " state=" + state
				+ " primary=" + primary + " x=" + x + " y=" + y + "}";
	}
