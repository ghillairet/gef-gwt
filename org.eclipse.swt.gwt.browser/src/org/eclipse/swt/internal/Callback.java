...
public class Callback {
	 ...
	 */
	public Callback(Object object, String method, int argCount,
			boolean isArrayBased, long /* int */errorResult) {
		//
		...
		System.out
				.println("Callback.Callback(Object,String,int,boolean,long) does nothing.");
	}
	 ...
	 * TODO
	 */
	// static native synchronized long /* int */bind(Callback callback,
	// Object object, String method, String signature, int argCount,
	// boolean isStatic, boolean isArrayBased, long /* int */errorResult);
	...
	/**
	 * This might be called directly from native code in environments which can
	 * generate spurious events. Check before removing it.
	 * 
	 * @deprecated
	 * 
	 * @param ignore
