...
/**
 * Instances of this class are sent whenever mouse related actions occur. This
 * includes mouse buttons being pressed and released, the mouse pointer being
 * moved and the mouse pointer crossing widget boundaries.
 * <p>
 * Note: The <code>button</code> field is an integer that represents the mouse
 * button number. This is not the same as the <code>SWT</code> mask constants
 * <code>BUTTONx</code>.
 * </p>
 * 
 * @see MouseListener
...
public class MouseEvent extends TypedEvent {
	...
	public String toString() {
		...
		return string.substring(0, string.length() - 1) // remove trailing '}'
				+ " button=" + button + " stateMask=" + stateMask + " x="
				+ x
				+ " y=" + y + " count=" + count + "}";
	}
}
