 ...
 * be added to a text widget using the <code>addModifyListener</code> method and
 * removed using the <code>removeModifyListener</code> method. When the text is
 * modified, the modifyText method will be invoked.
 * </p>
 * 
 * @see ModifyEvent
 */
