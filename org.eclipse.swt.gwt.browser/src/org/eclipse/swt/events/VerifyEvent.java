...
/**
 * Instances of this class are sent as a result of widgets handling keyboard
 * events
 * 
 * @see VerifyListener
...
public final class VerifyEvent extends KeyEvent {
	...
	/**
	 * the new text that will be inserted. Setting this field will change the
	 * text that is about to be inserted or deleted.
	 */
	public String text;
