 ...
 * be added to a control using the <code>addMouseMoveListener</code> method and
 * removed using the <code>removeMouseMoveListener</code> method. As the mouse
 * moves, the mouseMove method will be invoked.
 * </p>
 * 
 * @see MouseEvent
 */
