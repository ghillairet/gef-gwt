 ...
 * be added to a menu using the <code>addMenuListener</code> method and removed
 * using the <code>removeMenuListener</code> method. When the menu is hidden or
 * shown, the appropriate method will be invoked.
 * </p>
 * 
 * @see MenuAdapter
 * @see MenuEvent
