...
public class SWT {
	...
	/**
	 * Keyboard and/or mouse event mask indicating that the MOD1 key was pushed
	 * on the keyboard when the event was generated.
	 * 
	...
	/**
	 * Keyboard and/or mouse event mask indicating that the MOD2 key was pushed
	 * on the keyboard when the event was generated.
	 * 
	...
	/**
	 * Keyboard and/or mouse event mask indicating that the MOD3 key was pushed
	 * on the keyboard when the event was generated.
	 * 
	 * @since 2.1
	 */
	...
	/**
	 * Keyboard and/or mouse event mask indicating that the MOD4 key was pushed
	 * on the keyboard when the event was generated.
	 * 
	 * @since 2.1
	 */
	...
	/**
	 * Returns the SWT platform name. Examples: "win32", "motif", "gtk",
	 * "photon", "carbon", "cocoa", "wpf"
	 * 
	 ...
	 * which caused SWT to throw an exception.
	 * <p>
	...
	public static void error(int code, Throwable throwable, String detail) {
		 ...
		 * SWTExceptions which in turn contain other SWTErrors and SWTExceptions
	...
	static {
		...
		/*
		 * These values can be different on different platforms. Therefore they
		 * are not initialized in the declaration to stop the compiler from
		 * inlining.
		 */
