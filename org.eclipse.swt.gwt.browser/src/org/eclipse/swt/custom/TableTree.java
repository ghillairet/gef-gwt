...
public class TableTree extends Composite {
	...
	public TableTree(Composite parent, int style) {
		...
		int[] tableEvents = new int[] { SWT.MouseDown, SWT.Selection,
				SWT.DefaultSelection, SWT.KeyDown };
	...
	public Color getBackground() {
		// This method must be overridden otherwise, in a TableTree in which the
		// first
