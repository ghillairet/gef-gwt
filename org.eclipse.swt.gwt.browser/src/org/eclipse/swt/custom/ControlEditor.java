...
public class ControlEditor {
	...
	private final static int[] EVENTS = { SWT.KeyDown, SWT.KeyUp,
			SWT.MouseDown, SWT.MouseUp, SWT.Resize };
	...
	public void setEditor(Control editor) {
		...
		if (editor == null) {
			// this is the case where the caller is setting the editor to be
			// blank
