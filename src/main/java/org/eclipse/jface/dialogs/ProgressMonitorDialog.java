...
public class ProgressMonitorDialog extends IconAndMessageDialog implements
	...
	private class ProgressMonitor implements IProgressMonitorWithBlocking {
		 ...
		 * 
		 * @see
		 * org.eclipse.core.runtime.IProgressMonitorWithBlocking#setBlocked(
	 ...
	 */
	/**
	 * The <code>ProgressMonitorDialog</code> implementation of this method only
	 * closes the dialog if there are no currently running runnables.
	 */
	 ...
	 * create the dialog, based on the setting of <code>getOpenOnRun</code>, and
