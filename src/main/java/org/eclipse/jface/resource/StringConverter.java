...
/**
 * Helper class for converting various data types to and from strings. Supported
 * types include:
 * <ul>
...
public class StringConverter {
	...
	/**
	 * Internal constant for the separator character used in font
	 * specifications.
	 */
	 ...
	 * /** Breaks out space-separated words into an array of words. For example:
	 * <code>"no comment"</code> into an array <code>a[0]="no"</code> and
	 * <code>a[1]= "comment"</code>. Returns the given default value if the
	...
	/**
	 * Converts the given value into a boolean. This method fails if the value
	 * does not represent a boolean.
	 * <p>
	 * Valid representations of <code>true</code> include the strings "
	 * <code>t</code>", "<code>true</code>", or equivalent in mixed or upper
	 * case. Similarly, valid representations of <code>false</code> include the
	 * strings "<code>f</code>", "<code>false</code>", or equivalent in mixed or
	 * upper case.
	 * </p>
	 * 
	 * @param value
	...
	/**
	 * Converts the given value into a boolean. Returns the given default value
	...
	/**
	 * Converts the given value into a double. This method fails if the value
	...
	/**
	 * Converts the given value into a double. Returns the given default value
	 * if the value does not represent a double.
	 * 
	 * @param value
	 *            the value to be converted
	 * @param dflt
	...
	/**
	 * Converts the given value into a float. This method fails if the value
	...
	/**
	 * Converts the given value into a float. Returns the given default value if
	...
	/**
	 * Converts the given value into an SWT font data object. This method fails
	 * if the value does not represent font data.
	 * <p>
	 ...
	 * <code>"regular"</code>, <code>"bold"</code>, <code>"italic"</code>, or
	 * <code>"bold italic"</code>) and <code><it>height</it></code> is an
	 * integer representing the font height. Example:
	 * <code>Times New Roman-bold-36</code>.
	 * </p>
	 * 
	 * @param value
	 *            the value to be converted
	...
	/**
	 * Converts the given value into an SWT font data object. Returns the given
	 * default value if the value does not represent a font data object.
	 * 
	 * @param value
	 *            the value to be converted
	 * @param dflt
	...
	/**
	 * Converts the given value into an int. This method fails if the value does
	 * not represent an int.
	 * 
	 * @param value
	 *            the value to be converted
	...
	/**
	 * Converts the given value into an int. Returns the given default value if
	 * the value does not represent an int.
	 * 
	 * @param value
	 *            the value to be converted
	 * @param dflt
	...
	/**
	 * Converts the given value into a long. This method fails if the value does
	...
	/**
	 * Converts the given value into a long. Returns the given default value if
	 * the value does not represent a long.
	 * 
	 * @param value
	 *            the value to be converted
	 * @param dflt
	...
	/**
	 * Converts the given value into an SWT point. This method fails if the
	 * value does not represent a point.
	 * <p>
	 * A valid point representation is a string of the form
	 * <code><it>x</it>,<it>y</it></code> where <code><it>x</it></code> and
	 * <code><it>y</it></code> are valid ints.
	 * </p>
	 * 
	 * @param value
	 *            the value to be converted
	...
	/**
	 * Converts the given value into an SWT point. Returns the given default
	 * value if the value does not represent a point.
	 * 
	 * @param value
	 *            the value to be converted
	 * @param dflt
	 ...
	 * <code><it>x</it>,<it>y</it>,<it>width</it>,<it>height</it></code> where
	 * <code><it>x</it></code>, <code><it>y</it></code>,
	 * <code><it>width</it></code>, and <code><it>height</it></code> are valid
	 * ints.
	 * </p>
	 * 
	 * @param value
	...
	/**
	 * Converts the given value into an SWT rectangle. Returns the given default
	 * value if the value does not represent a rectangle.
	 * 
	 * @param value
	 *            the value to be converted
	 * @param dflt
	...
	/**
	 * Converts the given value into an SWT RGB color value. This method fails
	 * if the value does not represent an RGB color value.
	 * <p>
	...
	/**
	 * Converts the given value into an SWT RGB color value. Returns the given
	 * default value if the value does not represent an RGB color value.
	 * 
	 * @param value
	 *            the value to be converted
	 * @param dflt
	...
	/**
	 * Converts the given double value to a string. Equivalent to
	...
	/**
	 * Converts the given float value to a string. Equivalent to
	 * <code>String.valueOf(value)</code>.
	 * 
	 * @param value
	 *            the float value
	...
	/**
	 * Converts the given int value to a string. Equivalent to
	 * <code>String.valueOf(value)</code>.
	 * 
	 * @param value
	 *            the int value
	...
	/**
	 * Converts the given long value to a string. Equivalent to
	 * <code>String.valueOf(value)</code>.
	 * 
	 * @param value
	 *            the long value
	...
	/**
	 * Converts the given boolean object to a string. Equivalent to
	 * <code>String.valueOf(value.booleanValue())</code>.
	 * 
	 * @param value
	 *            the boolean object
	...
	/**
	 * Converts the given double object to a string. Equivalent to
	 * <code>String.valueOf(value.doubleValue())</code>.
	 * 
	 * @param value
	 *            the double object
	...
	/**
	 * Converts the given float object to a string. Equivalent to
	 * <code>String.valueOf(value.floatValue())</code>.
	 * 
	 * @param value
	 *            the float object
	...
	/**
	 * Converts the given integer object to a string. Equivalent to
	 * <code>String.valueOf(value.intValue())</code>.
	 * 
	 * @param value
	 *            the integer object
	...
	/**
	 * Converts the given long object to a string. Equivalent to
	 * <code>String.valueOf(value.longValue())</code>.
	 * 
	 * @param value
	 *            the long object
	...
	/**
	 * Converts a font data array to a string. The string representation is that
	 * of asString(FontData) seperated by ';'
	 * 
	 * @param value
	 *            The font data.
	 ...
	 * <code><it>x</it>,<it>y</it></code> where <code><it>x</it></code> and
	 * <code><it>y</it></code> are string representations of integers.
	 * </p>
	 * 
	 * @param value
	 *            the point object
	 ...
	 * <code><it>x</it>,<it>y</it>,<it>width</it>,<it>height</it></code> where
	 * <code><it>x</it></code>, <code><it>y</it></code>,
	 * <code><it>width</it></code>, and <code><it>height</it></code> are string
	...
	/**
	 * Converts the given boolean value to a string. Equivalent to
	 * <code>String.valueOf(value)</code>.
	 * 
	 * @param value
	 *            the boolean value
	 ...
	 * <code>'&#92;u0020'</code> (the space character) are considered to be a
	 * white space.
	 * </p>
	 * 
	 * @param s
	...
	/**
	 * Converts a font data object to a string representation for display. The
	 * string representation is "font name-style-height" (for example
