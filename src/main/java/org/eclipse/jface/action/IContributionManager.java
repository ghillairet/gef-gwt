 ...
 * </p>
 * <p>
 * There are several implementations of this interface in this package,
 * including ones for menus ({@link MenuManager <code>MenuManager</code>}), tool
 * bars ({@link ToolBarManager <code>ToolBarManager</code>}), and status lines (
...
public interface IContributionManager {
	 ...
	 * 
	 * @param action
	 *            the action, this cannot be <code>null</code>
	 */
	 ...
	 * 
	 * @param item
	 *            the contribution item, this cannot be <code>null</code>
	 */
	...
	/**
	 * Returns whether the list of contributions has recently changed and has
	 * yet to be reflected in the corresponding widgets.
	 * 
	 ...
	 * group with the given name. Equivalent to
	...
	/**
	 * Adds a contribution item to this manager at the beginning of the group
	 * with the given name.
	 * 
	 * @param groupName
	 *            the name of the group
