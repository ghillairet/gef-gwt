 ...
 * 
 * Where are the images? The images (typically gifs) are found the plugins
 * install directory
 * 
 * How to add a new image Place the gif file into the appropriate directories.
...
public/* final */class WorkbenchImages {
	...
	private final static void declareImages() {
		// Overlays
		declareImage(ISharedImages.IMG_DEC_FIELD_ERROR, PATH_OVERLAY
				+ "error_ovr.gif", true); //$NON-NLS-1$
		declareImage(ISharedImages.IMG_DEC_FIELD_WARNING, PATH_OVERLAY
				+ "warning_ovr.gif", true); //$NON-NLS-1$
		...
		declareImage(ISharedImages.IMG_TOOL_NEW_WIZARD, PATH_ETOOL
		...
		declareImage(IWorkbenchGraphicConstants.IMG_ETOOL_IMPORT_WIZ,
				PATH_ETOOL + "import_wiz.gif", false); //$NON-NLS-1$
		declareImage(IWorkbenchGraphicConstants.IMG_ETOOL_EXPORT_WIZ,
				PATH_ETOOL + "export_wiz.gif", false); //$NON-NLS-1$
		declareImage(IWorkbenchGraphicConstants.IMG_WIZBAN_IMPORT_WIZ,
				PATH_WIZBAN + "import_wiz.png", false); //$NON-NLS-1$
		declareImage(IWorkbenchGraphicConstants.IMG_WIZBAN_EXPORT_WIZ,
				PATH_WIZBAN + "export_wiz.png", false); //$NON-NLS-1$
		declareImage(IWorkbenchGraphicConstants.IMG_WIZBAN_IMPORT_PREF_WIZ,
				PATH_WIZBAN + "importpref_wiz.png", false); //$NON-NLS-1$
		declareImage(IWorkbenchGraphicConstants.IMG_WIZBAN_EXPORT_PREF_WIZ,
				PATH_WIZBAN + "exportpref_wiz.png", false); //$NON-NLS-1$
		...
		declareImage(IWorkbenchGraphicConstants.IMG_OBJ_SEPARATOR, PATH_OBJECT
				+ "separator.gif", true); //$NON-NLS-1$

		declareImage(IWorkbenchGraphicConstants.IMG_OBJ_NODE, PATH_OBJECT
				+ "generic_elements.gif", true); //$NON-NLS-1$
		declareImage(IWorkbenchGraphicConstants.IMG_OBJ_ELEMENT, PATH_OBJECT
				+ "generic_element.gif", true); //$NON-NLS-1$
		...
		declareImage(ISharedImages.IMG_LCL_LINKTO_HELP, PATH_ELOCALTOOL
				+ "linkto_help.gif", true); //$NON-NLS-1$
		...
		declareImage(ISharedImages.IMG_OBJS_DND_LEFT_SOURCE, PATH_POINTER
				+ "left_source.bmp", true); //$NON-NLS-1$
		declareImage(ISharedImages.IMG_OBJS_DND_LEFT_MASK, PATH_POINTER
				+ "left_mask.bmp", true); //$NON-NLS-1$
		declareImage(ISharedImages.IMG_OBJS_DND_RIGHT_SOURCE, PATH_POINTER
				+ "right_source.bmp", true); //$NON-NLS-1$
		declareImage(ISharedImages.IMG_OBJS_DND_RIGHT_MASK, PATH_POINTER
				+ "right_mask.bmp", true); //$NON-NLS-1$
		declareImage(ISharedImages.IMG_OBJS_DND_TOP_SOURCE, PATH_POINTER
				+ "top_source.bmp", true); //$NON-NLS-1$
		declareImage(ISharedImages.IMG_OBJS_DND_TOP_MASK, PATH_POINTER
				+ "top_mask.bmp", true); //$NON-NLS-1$
		declareImage(ISharedImages.IMG_OBJS_DND_BOTTOM_SOURCE, PATH_POINTER
				+ "bottom_source.bmp", true); //$NON-NLS-1$
		declareImage(ISharedImages.IMG_OBJS_DND_BOTTOM_MASK, PATH_POINTER
				+ "bottom_mask.bmp", true); //$NON-NLS-1$
		declareImage(ISharedImages.IMG_OBJS_DND_INVALID_SOURCE, PATH_POINTER
				+ "invalid_source.bmp", true); //$NON-NLS-1$
		declareImage(ISharedImages.IMG_OBJS_DND_INVALID_MASK, PATH_POINTER
				+ "invalid_mask.bmp", true); //$NON-NLS-1$
		declareImage(ISharedImages.IMG_OBJS_DND_STACK_SOURCE, PATH_POINTER
				+ "stack_source.bmp", true); //$NON-NLS-1$
		declareImage(ISharedImages.IMG_OBJS_DND_STACK_MASK, PATH_POINTER
				+ "stack_mask.bmp", true); //$NON-NLS-1$
		declareImage(ISharedImages.IMG_OBJS_DND_OFFSCREEN_SOURCE, PATH_POINTER
				+ "offscreen_source.bmp", true); //$NON-NLS-1$
		declareImage(ISharedImages.IMG_OBJS_DND_OFFSCREEN_MASK, PATH_POINTER
				+ "offscreen_mask.bmp", true); //$NON-NLS-1$
		declareImage(ISharedImages.IMG_OBJS_DND_TOFASTVIEW_SOURCE, PATH_POINTER
				+ "tofastview_source.bmp", true); //$NON-NLS-1$
		declareImage(ISharedImages.IMG_OBJS_DND_TOFASTVIEW_MASK, PATH_POINTER
		...
		Image vm2 = new Image(d, viewMenu.getImageData(),
				viewMenuMask.getImageData());
		viewMenu.dispose();
		viewMenuMask.dispose();

		getImageRegistry().put(
				IWorkbenchGraphicConstants.IMG_LCL_RENDERED_VIEW_MENU, vm2);

	}

	/**
	 * Declares all the workbench's deprecated hover images, including both
	 * "shared" ones and internal ones.
	 * 
	 * @deprecated As of 3.0, since the workbench itself no longer uses the
	 *             hover image variants
	 */
	...
	public static void declareImage(String symbolicName,
		...
		// if (image == null) {
		// WorkbenchPlugin
		//						.log("Image not found in WorkbenchImages.declaredImage().  symbolicName=" + symbolicName + " descriptor=" + descriptor, new Exception("stack dump")); //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$
		// } else {
		// image.dispose();
		// }
		// }
	 ...
	 */
	public static ImageDescriptor getWorkbenchImageDescriptor(
			String relativePath) {
		// return ImageDescriptor.createFromURL(BundleUtility.find(
		// PlatformUI.PLUGIN_ID, ICONS_PATH + relativePath));
		return null;
	}
}
