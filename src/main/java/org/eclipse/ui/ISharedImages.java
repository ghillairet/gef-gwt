...
public interface ISharedImages {
	ISharedImages STUB = new ISharedImages() {
	 ...
	 *             <code>IMG_TOOL_BACK</code>. Enabled images are now in color.
	 ...
	 * 
	 * @deprecated in 3.0. This image is now the same as
	 *             <code>IMG_TOOL_COPY</code>. Enabled images are now in color.
	 *             The workbench itself no longer uses the hover image variants.
	 */
	 ...
	 * 
	 * @deprecated in 3.0. This image is now the same as
	 *             <code>IMG_TOOL_CUT</code>. Enabled images are now in color.
	 *             The workbench itself no longer uses the hover image variants.
	 */
	 ...
	 * 
	 * @deprecated in 3.0. This image is now the same as
	 *             <code>IMG_TOOL_DELETE</code>. Enabled images are now in
	 ...
	 * 
	 * @deprecated in 3.0. This image is now the same as
	 *             <code>IMG_TOOL_FORWARD</code>. Enabled images are now in
	 *             color. The workbench itself no longer uses the hover image
	 *             variants.
	 */
	 ...
	 * 
	 * @deprecated in 3.0. This image is now the same as
	 *             <code>IMG_TOOL_PASTE</code>. Enabled images are now in color.
	 *             The workbench itself no longer uses the hover image variants.
	 */
	 ...
	 * 
	 * @deprecated in 3.0. This image is now the same as
	 *             <code>IMG_TOOL_REDO</code>. Enabled images are now in color.
	 *             The workbench itself no longer uses the hover image variants.
	 */
	 ...
	 * 
	 * @deprecated in 3.0. This image is now the same as
	 *             <code>IMG_TOOL_UNDO</code>. Enabled images are now in color.
	 *             The workbench itself no longer uses the hover image variants.
	 */
	 ...
	 * 
	 * @deprecated in 3.0. This image is now the same as
	 *             <code>IMG_TOOL_UP</code>. Enabled images are now in color.
	 *             The workbench itself no longer uses the hover image variants.
	 */
	...
	// cursor = new Cursor(display, source.getImageData(), mask.getImageData(),
	// 16, 16);
	...
	/**
	 * Cursor 'source' for the 'no drop' arrow cursor. For cursor construction
	 * see:
	 * 
	 * @see Cursor#Cursor(Device, ImageData, ImageData, int, int)
	 * @since 3.5
	...
	/**
	 * Cursor 'mask' for the 'no drop' arrow cursor. For cursor construction
	 * see:
	 * 
	 * @see Cursor#Cursor(Device, ImageData, ImageData, int, int)
	 * @since 3.5
	...
	/**
	 * Cursor 'source' for the 'in stack' arrow cursor. For cursor construction
	 * see:
	 * 
	 * @see Cursor#Cursor(Device, ImageData, ImageData, int, int)
	 * @since 3.5
	...
	/**
	 * Cursor 'mask' for the 'in stack' arrow cursor. For cursor construction
	 * see:
	 * 
	 * @see Cursor#Cursor(Device, ImageData, ImageData, int, int)
	 * @since 3.5
	...
	/**
	 * Cursor 'mask' for the 'off-screen' (detached window) arrow cursor. For
	 * cursor construction see:
	 * 
	 * @see Cursor#Cursor(Device, ImageData, ImageData, int, int)
	 * @since 3.5
	...
	/**
	 * Cursor 'mask' for the 'fast-view' arrow cursor. For cursor construction
	 * see:
	 * 
	 * @see Cursor#Cursor(Device, ImageData, ImageData, int, int)
	 * @since 3.5
	 ...
	 * Note: The returned <code>Image</code> is managed by the workbench;
	 * clients must <b>not</b> dispose of the returned image.
	 * 
	 * @param symbolicName
	 ...
	 * image registry. Unlike <code>Image</code>s, image descriptors themselves
	 * do not need to be disposed.
	 * 
	 * @param symbolicName
	 *            the symbolic name of the image; there are constants declared
	 *            in this interface for build-in images that come with the
