...
public interface IWorkbenchListener {
	 ...
	 * </p>
	 * <p>
	 * Since other workbench listeners may veto the shutdown, the listener
	 * should not dispose resources or do any other work during this
	 * notification that would leave the workbench in an inconsistent state.
	 * </p>
	 * 
	 * @param workbench
	 *            the workbench
	 * @param forced
	 *            <code>true</code> if the workbench is being forced to
