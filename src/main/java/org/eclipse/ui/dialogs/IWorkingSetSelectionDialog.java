...
public interface IWorkingSetSelectionDialog {
	/**
	 * Returns the working sets selected in the dialog or <code>null</code> if
	 ...
	 *         confirmed. Window.CANCEL if the dialog closes with the working
	 *         set selection dismissed.
