...
public interface IPerspectiveRegistry {
	 ...
	 * 
	 * @param id
	 *            the id for the cloned perspective, which must not already be
	...
	/**
	 * Returns the id of the default perspective for the workbench. This
	 * identifies one perspective extension within the workbench's perspective
	 * registry.
	 * <p>
	...
	/**
	 * Sets the default perspective for the workbench to the given perspective
	 * id. If non-<code>null</code>, the id must correspond to a perspective
