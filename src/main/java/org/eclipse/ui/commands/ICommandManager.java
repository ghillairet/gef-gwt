...
public interface ICommandManager {
	 ...
	 *            register. Must not be <code>null</code>. If an attempt is made
	 ...
	 * </p>
	 * 
	 * @return the set of identifiers to active contexts. This set may be empty,
	 ...
	 *         but it is guaranteed to not be <code>null</code>. If this set is
	 *         not empty, it is guaranteed to only contains instances of
	 *         <code>String</code>.
	 */
	...
	/**
	 * Unregisters an instance of <code>ICommandManagerListener</code> listening
	 * for changes to attributes of this instance.
	 * 
	 * @param commandManagerListener
	 *            the instance of <code>ICommandManagerListener</code> to
