...
public interface ICommand extends Comparable {
	 ...
	 *            register an instance of <code>ICommandListener</code> which is
	 ...
	 * it currently has an <code>IHandler</code> instance associated with it. A
	 * command needs a handler to carry out the {@link ICommand#execute(Map)}
	 * method.
	 * </p>
	 * <p>
	 * Notification is sent to all registered listeners if this attribute
	 ...
	 *            Must not be <code>null</code>. If an attempt is made to
	 *            unregister an instance of <code>ICommandListener</code> which
