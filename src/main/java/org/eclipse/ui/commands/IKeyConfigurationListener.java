...
public interface IKeyConfigurationListener {
	 ...
	 * <code>IKeyConfiguration</code> have changed. Specific details are
	 * described in the <code>KeyConfigurationEvent</code>.
	 * 
	 * @param keyConfigurationEvent
	 *            the keyConfiguration event. Guaranteed not to be
	 *            <code>null</code>.
	 */
