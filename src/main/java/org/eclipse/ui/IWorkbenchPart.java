...
public interface IWorkbenchPart extends IAdaptable {
	 ...
	 * <li>Register any global actions with the site's <code>IActionBars</code>.
	 * </li>
	...
	/**
	 * Asks this part to take focus within the workbench. Parts must assign
	 * focus to one of the controls contained in the part's parent composite.
	 * <p>
	 * Clients should not call this method (the workbench calls this method at
