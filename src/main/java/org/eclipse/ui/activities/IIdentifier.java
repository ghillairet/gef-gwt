...
public interface IIdentifier extends Comparable {
	...
	/**
	 * Returns the set of activity ids that this instance matches. Each activity
	 * in this set will have at least one pattern binding that matches the
	 * string returned by {@link #getId()}.
	 * <p>
	...
	/**
	 * Removes an instance of <code>IIdentifierListener</code> listening for
	 * changes to properties of this instance.
	 * 
	 * @param identifierListener
