...
public interface IActivity extends Comparable {
	 ...
	 *            the instance to register. Must not be <code>null</code>. If an
	 *            attempt is made to register an instance which is already
	...
	/**
	 * Returns whether or not this instance is defined. A defined activity may
	 * have a name, description and bindings (both pattern and relational).
	 * <p>
	 * Notification is sent to all registered listeners if this property
	 * changes.
	 * </p>
	 ...
	 * 
	 * @return <code>true</code>, iff this instance should be enabled by
	 *         default.
	 * @throws NotDefinedException
	 *             if this instance is not defined.
	 * @since 3.1
	...
	/**
	 * Removes an instance of <code>IActivityListener</code> listening for
	 * changes to properties of this instance.
	 * 
	 * @param activityListener
	 *            the instance to remove. Must not be <code>null</code>. If an
	 *            attempt is made to remove an instance which is not already
	 *            registered with this instance, no operation is performed.
	 */
