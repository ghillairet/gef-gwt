...
public interface IWorkbenchActionConstants {
	 ...
	 * constants. There doesn't seem to be much point for this. Recommend
	 * deleting it. ]
	 * </p>
	 */
	...
	/**
	 * ID of the Project configure popup menu, can be used in menuContributions
	 ...
	 * 
	 * @deprecated in 3.0. Use
	 *             {@link org.eclipse.ui.actions.ActionFactory#CLOSE
	 *             ActionFactory.CLOSE.getId()} instead.
	 */
	public static final String CLOSE = "close"; //$NON-NLS-1$

	/**
	 * File menu: name of standard Close All action (value
	 * <code>"closeAll"</code>).
	 * 
	 * @deprecated in 3.0. Use
	 ...
	 * 
	 * @deprecated in 3.0. Use
	 *             {@link org.eclipse.ui.actions.ActionFactory#SAVE_AS
	...
	/**
	 * File menu: name of standard Print global action (value
	 * <code>"print"</code>).
	 * 
	 * @deprecated in 3.0. Use
	 *             {@link org.eclipse.ui.actions.ActionFactory#PRINT
	...
	/**
	 * Edit menu: name of standard Paste global action (value
	 * <code>"paste"</code>).
	 * 
	 * @deprecated in 3.0. Use
	 *             {@link org.eclipse.ui.actions.ActionFactory#PASTE
	 ...
	 * 
	 * @deprecated in 3.0. Use
	 *             {@link org.eclipse.ui.actions.ActionFactory#DELETE
	...
	// Workbench toolbar group ids. To add an item at the beginning of the
	// group,
	 ...
	 * 
	 * @deprecated in 3.0. Use
	 *             {@link org.eclipse.ui.actions.ActionFactory#REVERT
	 ...
	 * 
	 * @deprecated in 3.0. Use
	 *             {@link org.eclipse.ui.actions.ActionFactory#REFRESH
	 ...
	 * 
	 * @deprecated in 3.0. Use
	 *             {@link org.eclipse.ui.actions.ActionFactory#RENAME
	 ...
	 * 
	 * @deprecated in 3.0. Use
	 *             {@link org.eclipse.ui.actions.ActionFactory#FORWARD
	 ...
	 * 
	 * @deprecated in 3.0. Use
	 *             {@link org.eclipse.ui.actions.ActionFactory#ABOUT
