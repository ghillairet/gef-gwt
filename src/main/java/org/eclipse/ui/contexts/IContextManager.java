...
public interface IContextManager {
	 ...
	 * the depth of the context within the tree of contexts. So, for example, a
	 * child context will always appear before its parent.
	 * <p>
	...
	/**
	 * Unregisters an instance of <code>IContextManagerListener</code> listening
	 * for changes to properties of this instance.
	 * 
	 * @param contextManagerListener
	 *            the instance to unregister. Must not be <code>null</code>. If
	 *            an attempt is made to unregister an instance which is not
