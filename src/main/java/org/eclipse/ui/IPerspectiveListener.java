...
public interface IPerspectiveListener {
	 ...
	 * 
	 * @param page
	 *            the page containing the activated perspective
	 * @param perspective
	 *            the perspective descriptor that was activated
	 ...
	 * 
	 * @param page
	 *            the page containing the affected perspective
	 * @param perspective
	 *            the perspective descriptor
	 * @param changeId
	 *            one of the <code>CHANGE_*</code> constants on IWorkbenchPage
	 */
