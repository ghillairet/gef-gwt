...
public interface IWorkbenchCommandConstants {
	...
	/**
	 * Id for command "Toggle Link with Editor " in category "Navigate" (value
	 * is <code>"org.eclipse.ui.navigate.linkWithEditor"</code>).
	 */
	...
	/**
	 * Id for command "Close Unrelated Projects" in category "Project". (value
	 * is <code>"org.eclipse.ui.project.closeUnrelatedProjects"</code>).
	 */
