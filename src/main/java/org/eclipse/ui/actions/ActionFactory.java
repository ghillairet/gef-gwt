...
public abstract class ActionFactory {
	...
	//
	// /**
	// * Workbench action (id: "about", commandId:
	// * "org.eclipse.ui.help.aboutAction"): Displays the About dialog. This
	...
	// .setHelp(action, IWorkbenchHelpContextIds.ABOUT_ACTION);
	// return action;
	// }
	// };
	//
	...
	// * "org.eclipse.ui.window.activateEditor"): Activate the most recently
	// used
	...
	//
	// /**
	// * Workbench action (id: "back", commandId:
	// "org.eclipse.ui.navigate.back"):
	// * Back. This action is a {@link RetargetAction} with id "back". This
	// action
	...
	//
	// /**
	// * Workbench action (id: "close", commandId: "org.eclipse.ui.file.close"):
	// * Close the active editor. This action maintains its enablement state.
	// */
	...
	//
	// /**
	// * Workbench action (id: "closeAll", commandId:
	// * "org.eclipse.ui.file.closeAll"): Close all open editors. This action
	// * maintains its enablement state.
	// */
	...
	// * "org.eclipse.ui.file.closeOthers"): Close all editors except the one
	// that
	// * is active. This action maintains its enablement state.
	// *
	// * @since 3.2
	// */
	// public static final ActionFactory CLOSE_OTHERS = new ActionFactory(
	//			"closeOthers",//$NON-NLS-1$
	...
	// * "org.eclipse.ui.window.closeAllPerspectives"): Closes all perspectives.
	// * This action maintains its enablement state.
	// */
	// public static final ActionFactory CLOSE_ALL_PERSPECTIVES = new
	// ActionFactory(
	...
	// * "org.eclipse.ui.window.closePerspective"): Closes the current
	...
	// window.getWorkbench()
	// .getHelpSystem()
	// .setHelp(action, IWorkbenchHelpContextIds.CLOSE_PAGE_ACTION);
	// return action;
	// }
	// };
	//
	...
	// * "org.eclipse.ui.help.quickStartAction"): Activate the introduction
	// * extension. This action should not be instantiated if no intro is
	// * provided. Use code like:
	// *
	// * <pre>
	...
	// IntroDescriptor introDescriptor = ((Workbench) window
	...
	//
	// /**
	// * Workbench action (id: "copy", commandId: "org.eclipse.ui.edit.copy"):
	// * Copy. This action is a {@link RetargetAction} with id "copy". This
	// action
	// * maintains its enablement state.
	// */
	 ...
	 * This action is a {@link RetargetAction} with id "cut". This action
	 * maintains its enablement state.
	 */
	...
	//
	// /**
	// * Workbench action (id: "delete", commandId:
	// "org.eclipse.ui.edit.delete"):
	// * Delete. This action is a {@link RetargetAction} with id "delete". This
	// * action maintains its enablement state.
	// */
	...
	// * "org.eclipse.ui.window.customizePerspective"): Edit the action sets.
	// This
	// * action maintains its enablement state.
	// */
	...
	//
	// /**
	// * Workbench action (id: "export", commandId:
	...
	// window.getWorkbench().getHelpSystem()
	// .setHelp(action, IWorkbenchHelpContextIds.EXPORT_ACTION);
	...
	//
	/**
	 * Workbench action (id: "find", commandId:
	 * "org.eclipse.ui.edit.findReplace"): Find. This action is a
	 * {@link RetargetAction} with id "find". This action maintains its
	 * enablement state.
	 */
	...
	// * "org.eclipse.ui.navigate.forwardHistory"): Forward in the navigation
	// * history. This action maintains its enablement state.
	// */
	...
	//
	// /**
	// * Workbench action (id: "goInto", commandId:
	// * "org.eclipse.ui.navigate.goInto"): Go Into. This action is a
	...
	//
	// /**
	// * Workbench action (id: "import", commandId:
	...
	// window.getWorkbench().getHelpSystem()
	// .setHelp(action, IWorkbenchHelpContextIds.IMPORT_ACTION);
	// action.setImageDescriptor(WorkbenchImages
	...
	// * "org.eclipse.ui.window.maximizePart"): Maximize/restore the active
	// part.
	// * This action maintains its enablement state.
	// */
	...
	//
	// /**
	// * Workbench action (id: "move", commandId: "org.eclipse.ui.edit.move"):
	// * Move. This action is a {@link RetargetAction} with id "move". This
	// action
	// * maintains its enablement state.
	// */
	...
	//
	// /**
	// * Workbench action (id: "new", commandId: "org.eclipse.ui.newWizard"):
	// * Opens the new wizard dialog. This action maintains its enablement
	// state.
	// */
	...
	//
	// /**
	// * Workbench action (id: "newWizardDropDown"): Drop-down action which
	// shows
	...
	// * @since 3.1
	// */
	// public static final ActionFactory NEW_WIZARD_DROP_DOWN = new
	// ActionFactory(
	...
	//
	// /**
	// * Workbench action (id: "next", commandId:
	// "org.eclipse.ui.navigate.next"):
	// * Next. This action is a {@link RetargetAction} with id "next". This
	// action
	// * maintains its enablement state.
	// */
	...
	// * "org.eclipse.ui.window.nextEditor"): Next editor. This action maintains
	...
	// form
	// * a cycle action pair. For a given window, use
	// * {@link ActionFactory#linkCycleActionPair
	// * ActionFactory.linkCycleActionPair</code>} to connect the two.
	// * </p>
	// */
	...
	// * "org.eclipse.ui.window.newWindow"): Open a new workbench window. This
	// * action maintains its enablement state.
	// */
	...
	// * Paste. This action is a {@link RetargetAction} with id "paste". This
	// * action maintains its enablement state.
	// */
	...
	// * "org.eclipse.ui.window.preferences"): Displays the Preferences dialog.
	// * This action maintains its enablement state.
	// */
	...
	// * "org.eclipse.ui.window.previousView"): Previous part. This action
	// * maintains its enablement state.
	// * <p>
	// * <code>NEXT_PART</code> and <code>PREVIOUS_PART</code> form a cycle
	// action
	...
	// * "org.eclipse.ui.window.previousPerspective"): Previous perspective.
	// This
	// * action maintains its enablement state.
	// * <p>
	// * <code>NEXT_PERSPECTIVE</code> and <code>PREVIOUS_PERSPECTIVE</code>
	...
	// * </p>
	// */
	// public static final ActionFactory PREVIOUS_PERSPECTIVE = new
	// ActionFactory(
	...
	// * Print. This action is a {@link RetargetAction} with id "print". This
	// * action maintains its enablement state.
	// */
	...
	//
	// /**
	// * Workbench action (id: "quit", commandId: "org.eclipse.ui.file.exit"):
	// * Quit (close the workbench). This action maintains its enablement state.
	// */
	...
	// window.getWorkbench().getHelpSystem()
	// .setHelp(action, IWorkbenchHelpContextIds.QUIT_ACTION);
	// return action;
	// }
	// };
	//
	// /**
	// * Workbench action (id: "redo", commandId: "org.eclipse.ui.edit.redo"):
	// * Redo. This action is a {@link RetargetAction} with id "redo". This
	// action
	// * maintains its enablement state.
	// */
	...
	//
	// /**
	// * Workbench action (id: "refresh", commandId:
	// * "org.eclipse.ui.file.refresh"): Refresh. This action is a
	...
	//
	// /**
	// * Workbench action (id: "rename", commandId:
	// "org.eclipse.ui.edit.rename"):
	// * Rename. This action is a {@link RetargetAction} with id "rename". This
	// * action maintains its enablement state.
	// */
	...
	// * "org.eclipse.ui.window.resetPerspective"): Resets the current
	// * perspective. This action maintains its enablement state.
	// */
	...
	//
	// /**
	// * Workbench action (id: "revert", commandId:
	// "org.eclipse.ui.file.revert"):
	// * Revert. This action is a {@link RetargetAction} with id "revert". This
	// * action maintains its enablement state.
	// */
	...
	//
	// /**
	// * Workbench action (id: "save", commandId: "org.eclipse.ui.file.save"):
	// * Save the active editor. This action maintains its enablement state.
	// */
	...
	//
	// /**
	// * Workbench action (id: "saveAll", commandId:
	// * "org.eclipse.ui.file.saveAll"): Save all open editors with unsaved
	...
	//
	// /**
	// * Workbench action (id: "saveAs", commandId:
	// "org.eclipse.ui.file.saveAs"):
	// * Save As for the active editor. This action maintains its enablement
	// * state.
	// */
	...
	// * "org.eclipse.ui.window.savePerspective"): Save the current perspective.
	// * This action maintains its enablement state.
	// */
	...
	// }
	// WorkbenchCommandAction action = new WorkbenchCommandAction(
	//					"org.eclipse.ui.window.switchToEditor", window); //$NON-NLS-1$
	// action.setId(getId());
	...
	//
	// /**
	// * Workbench action (id: "showWorkbookEditors"): Shows a list of open
	// * editors in the current or last active workbook.
	// */
	// public static final ActionFactory SHOW_WORKBOOK_EDITORS = new
	// ActionFactory(
	...
	//
	// WorkbenchCommandAction action = new WorkbenchCommandAction(
	//					"org.eclipse.ui.window.openEditorDropDown", window); //$NON-NLS-1$
	// action.setId(getId());
	...
	//
	// /**
	// * Workbench action (id: "showQuickAccess"): Shows a list of UI elements
	// * like editors, views, perspectives etc.
	// *
	// * @since 3.3
	// */
	...
	// public IWorkbenchAction create(IWorkbenchWindow window) {
	// WorkbenchCommandAction action = new WorkbenchCommandAction(
	//					"org.eclipse.ui.window.quickAccess", window); //$NON-NLS-1$
	// action.setId(getId());
	...
	// * action maintains its enablement state.
	// */
	// public static final ActionFactory SHOW_PART_PANE_MENU = new
	// ActionFactory(
	...
	// }
	// WorkbenchCommandAction action = new WorkbenchCommandAction(
	//					"org.eclipse.ui.window.showSystemMenu", window); //$NON-NLS-1$
	// action.setId(getId());
	...
	//
	/**
	 * Workbench action (id: "undo", commandId: "org.eclipse.ui.edit.undo"):
	 * Undo. This action is a {@link RetargetAction} with id "undo". This action
	 * maintains its enablement state.
	 */
	...
	//
	// /**
	// * Workbench action (id: "up", commandId: "org.eclipse.ui.navigate.up"):
	// Up.
	// * This action is a {@link RetargetAction} with id "up". This action
	// * maintains its enablement state.
	// */
	...
	// * "org.eclipse.ui.help.helpContents"): Open the help contents. This
	// action
	// * is always enabled.
	// */
	...
	// * "org.eclipse.ui.help.dynamicHelp"): Open the dynamic help. This action
	// is
	// * always enabled.
	// *
	// * @since 3.1
	...
	// * "org.eclipse.ui.perspectives.showPerspective"): Open the Open
	// Perspective
	// * dialog. This action is always enabled.
	// *
	// * @since 3.1
	// */
	// public static final ActionFactory OPEN_PERSPECTIVE_DIALOG = new
	// ActionFactory(
	...
	// * "org.eclipse.ui.window.newEditor"): Open a new editor on the active
	// * editor's input. This action maintains its enablement state.
	// *
	// * @since 3.1
	// */
	...
	// * coolbar and perspective switcher. This will only enable visibility of
	// the
	...
	// *
	// * <pre>
	// * ActionFactory.IWorkbenchAction nextEditorAction =
	// ActionFactory.NEXT_EDITOR
	// * .create(window);
	// * ActionFactory.IWorkbenchAction previousEditorAction =
	// ActionFactory.PREVIOUS_EDITOR
	// * .create(window);
	// * ActionFactory.linkCycleActionPair(nextEditorAction,
	...
	//
	// /**
	// * Creates a new standard action for the given workbench window. The
	// action
