...
public abstract class WorkbenchPart extends EventManager implements
	...
	/*
	 * (non-Javadoc) Creates the SWT controls for this workbench part. <p>
	 * Subclasses must implement this method. For a detailed description of the
	 * requirements see <code>IWorkbenchPart</code> </p>
	 * 
	 ...
	 * {@inheritDoc}
	 * <p>
	 * It is considered bad practise to overload or extend this method. Parts
	 * should set their title by calling setPartName and/or
	...
	/*
	 * (non-Javadoc) Asks this part to take focus within the workbench. Parts
	 * must assign focus to one of the controls contained in the part's parent
	 * composite. <p> Subclasses must implement this method. For a detailed
	 * description of the requirements see <code>IWorkbenchPart</code> </p>
	 * 
	 * @see IWorkbenchPart
	 */
	 ...
	 * ). It also loads the title image, if one is specified in the
	...
	public void setInitializationData(IConfigurationElement cfig,
		...
		titleImage = JFaceResources.getResources().createImageWithDefault(
				imageDescriptor);
	}
	...
	/**
	 * Sets or clears the title tool tip text of this part. Clients should call
	 * this method instead of overriding <code>getTitleToolTip</code>
	 * 
	 * @param toolTip
	 ...
	 * 
	 * @param busy
	 *            boolean to indicate that the busy state has started or ended.
	 ...
	 * <p>
	 * It is considered bad practise to overload or extend this method. Parts
	 * should call setPartName to change their part name.
	 * </p>
	 */
	 ...
	 * the part. Clients should call this method instead of overriding
	 * getPartName. Setting this to the empty string will cause a default part
	 * name to be used.
	 * 
	 * <p>
	...
	void setDefaultTitle() {
		...
		// newTitle = MessageFormat.format(
		// WorkbenchMessages.WorkbenchPart_AutoTitleFormat,
	 ...
	 * <p>
	 * It is considered bad practise to overload or extend this method. Parts
	 * should call setContentDescription to change their content description.
	 * </p>
	 */
	 ...
	 * typically a short string describing the current contents of the part.
	 * Setting this to the empty string will cause a default content description
	 * to be used. Clients should call this method instead of overriding
	 ...
	 * description is shown beside the part name when showing a list of editors.
	 * If the editor is open on a file, this typically contains the path to the
	 * input file, without the filename or trailing slash.
	 * 
	 * <p>
	 ...
	 * 
	 * @see
	 * org.eclipse.ui.IWorkbenchPart3#addPartPropertyListener(org.eclipse.jface
	 ...
	 * 
	 * @see
	 * org.eclipse.ui.IWorkbenchPart3#removePartPropertyListener(org.eclipse
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.ui.IWorkbenchPart3#setPartProperty(java.lang.String,
	 * java.lang.String)
	 */
