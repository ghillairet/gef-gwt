...
public class EditorActionBarContributor implements IEditorActionBarContributor {
	 ...
	 * <code>IEditorActionBarContributor</code> method does nothing, subclasses
	 * may override.
	 */
	public void dispose() {
	}
	 ...
	 * manager if <code>IActionBars</code> is of extended type
	 * <code>IActionBars2</code></li>
	 * <li><code>contributeToStatusLine</code> with <code>bars</code>' status
	 * line manager</li>
	 * </ul>
