...
public interface IPartListener2 {
	 ...
	 * <p>
	 * These events occur when an editor is brought to the top in the editor
	 * area, or when a view is brought to the top in a page book with multiple
	 * views. They are normally only sent when a part is brought to the top
	...
	/**
	 * Notifies this listener that the given part is hidden or obscured by
	 * another part.
	 * 
	 * @param partRef
