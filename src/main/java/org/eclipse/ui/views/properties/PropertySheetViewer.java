...
class PropertySheetViewer extends Viewer {
	...
	// * TreeItem. This is used in 'findItem' to greatly increase the
	// performance.
	// */
	...
	// PropertiesMessages.PropertyViewer_misc;
	//
	// // Cell editor support.
	...
	//
	// /**
	// * Creates a property sheet viewer on a newly-created tree control under
	// the
	...
	// method
	// * is called when the item is expanded for the first time or when an item
	// is
	...
	//
	// /**
	// * Sends out a selection changed event for the entry tree to all
	// registered
	// * listeners.
	// */
	...
	// * user data field as the supplied entry. Return <code>null</code> if
	// there
	// * is no such item.
	// *
	// * @param entry
	...
	//
	// /**
	// * Notifies all registered cell editor activation listeners of a cell
	// editor
	// * activation.
	// *
	...
	// IPropertySheetEntry[] propertySheetEntries = (IPropertySheetEntry[])
	// unsortedEntries
	...
	//
	// /**
	// * Returns the root entry for this property sheet viewer. The root entry
	// is
	...
	//
	// /**
	// * The expand icon for a node in this viewer has been selected to collapse
	// a
	...
	//
	// /**
	// * The expand icon for a node in this viewer has been selected to expand
	// the
	// * subtree. Create the children 1 level deep.
	// * <p>
	// * Note that we use a "dummy" item (no user data) to show a "+" icon
	// beside
	...
	// * <p>
	// * The default sorter sorts categories and entries alphabetically. A
	// viewer
	...
	// }
	//
	// PropertySheetCategory[] categoryArray = (PropertySheetCategory[])
	// categoryList
	...
	// */
	// private void updateCategory(PropertySheetCategory category, TreeItem
	// item) {
