...
public class PropertyDescriptor implements IPropertyDescriptor {
	 ...
	 * 
	 * @param category
	 *            the category for the descriptor, or <code>null</code> if none
	 * @see #getCategory
	 */
	 ...
	 * 
	 * @param provider
	 *            the label provider for the descriptor, or <code>null</code> if
	 *            the default label provider should be used
