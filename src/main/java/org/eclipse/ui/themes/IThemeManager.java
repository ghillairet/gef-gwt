...
public interface IThemeManager {
	 ...
	 * fired. This event is the same event that was fired by the registry. As
	 * such, the "source" attribute of the event will not be this manager, but
	 * rather the color or font registry. Additionally, an event is fired when
	 * the current theme changes to a new theme. The "property" attribute of
	 * such an event will have the value
	 ...
	 * @param id
	 *            the theme to find.
	 * @return the <code>ITheme</code> or <code>null</code> if it cannot be
	 *         found.
	 */
