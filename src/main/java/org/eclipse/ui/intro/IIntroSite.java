...
public interface IIntroSite extends IWorkbenchSite {
	 ...
	 * @deprecated Use IServiceLocator#getService(*) to retrieve IContextService
	 *             and IHandlerService instead.
	 */
	public IKeyBindingService getKeyBindingService();

	/**
	 * Returns the action bars for this part site. The intro part has exclusive
	 * use of its site's action bars.
	 * 
