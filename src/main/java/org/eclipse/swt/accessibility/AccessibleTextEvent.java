 ...
 * messages to controls asking for detailed information about the implementation
 * of the control instance. Typically, only implementors of custom controls need
...
public class AccessibleTextEvent extends SWTEventObject {
	...
	/**
	 * The value of this field must be set in the accessible text extended
	 * listener method before returning. What to set it to depends on the
