/*******************************************************************************
 * Copyright (c) 2009, 2011, 2012 IBM Corporation, Gerhardt Informatics Kft. and others.
 ...
 * AccessibleAttribute or AccessibleEditableText messages to an accessible
 * object.
 * 
...
public class AccessibleTextAttributeEvent extends SWTEventObject {
	...
	/**
	 * [in/out] an array of alternating key and value Strings that represent
	 * attributes that do not correspond to TextStyle fields
	 * 
	 * @see AccessibleAttributeListener#getTextAttributes
	 * @see AccessibleEditableTextListener#setTextAttributes
	 */
	 ...
	 * successfully, and null otherwise.
	 * 
	 * @see AccessibleEditableTextListener#setTextAttributes
	 * 
	 * @since 3.7
