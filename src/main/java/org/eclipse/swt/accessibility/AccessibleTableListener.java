 ...
 * AccessibleTable events.
 * <p>
 * After creating an instance of a class that implements this interface it can
 * be added to an accessible using the <code>addAccessibleTableListener</code>
 * method and removed using the <code>removeAccessibleTableListener</code>
 * method.
 * </p>
 * <p>
 * Many methods in this listener return cell accessible objects, which should
 * implement <code>AccessibleTableCellListener</code>.
 * </p>
 * 
...
public interface AccessibleTableListener extends SWTEventListener {
	 ...
	 *            <ul>
	 *            <li>[in] column - 0 based index of the column to be
	 *            unselected.</li>
	 *            <li>[out] result - set to {@link ACC#OK} if the column was
	 *            deselected.</li>
	 *            </ul>
	 */
	 ...
	 *            <li>[out] result - set to {@link ACC#OK} if the row was
	 *            deselected.</li>
	 *            </ul>
	 */
	 ...
	 *            an event object containing the following fields:
	 *            <ul>
	 *            <li>[out] accessible - the caption for the table, or null if
	 *            the table does not have a caption</li>
	 *            </ul>
	 */
	public void getCaption(AccessibleTableEvent e);

	/**
	 * Returns the accessible object at the specified row and column in the
	 * table.
	 * 
	 * @param e
	 *            an event object containing the following fields:
	 *            <ul>
	 *            <li>[in] row - the 0 based row index for which to retrieve the
	 *            accessible cell</li>
	 *            <li>[in] column - the 0 based column index for which to
	 *            retrieve the accessible cell</li>
	 *            <li>[out] accessible - the table cell at the specified row and
	 *            column index, or null if the row or column index are not valid
	 *            </li>
	 *            </ul>
	 */
	 ...
	 *            <ul>
	 *            <li>[in] column - the 0 based column index for which to
	 *            retrieve the accessible column</li>
	 *            <li>[out] accessible - the table column at the specified
	 *            column index, or null if the column index is not valid</li>
	 *            </ul>
	 */
	 ...
	 *            an event object containing the following fields:
	 *            <ul>
	 *            <li>[in] column - the 0 based index of the column for which to
	 *            retrieve the description</li>
	 *            <li>[out] result - the description text of the specified
	 *            column in the table, or null if the column does not have a
	 *            description</li>
	 *            </ul>
	 */
	 ...
	 *            an event object containing the following fields:
	 *            <ul>
	 *            <li>[out] accessible - an accessible object representing the
	 *            column header, or null if there is no column header</li>
	 *            </ul>
	 */
	 ...
	 *            an event object containing the following fields:
	 *            <ul>
	 *            <li>[out] accessibles - an array of accessible objects
	 *            representing column header cells, or null if there are no
	 *            column header cells</li>
	 *            </ul>
	 */
	 ...
	 *            <ul>
	 *            <li>[out] accessibles - an array of accessible objects
	 *            representing columns, or null if there are no columns</li>
	 *            </ul>
	 */
	 ...
	 *            <li>[in] row - the 0 based row index for which to retrieve the
	 *            accessible row</li>
	 *            <li>[out] accessible - the table row at the specified row
	 *            index, or null if the row index is not valid</li>
	 *            </ul>
	 */
	 ...
	 *            an event object containing the following fields:
	 *            <ul>
	 *            <li>[in] row - the 0 based index of the row for which to
	 *            retrieve the description</li>
	 *            <li>[out] result - the description text of the specified row
	 *            in the table, or null if the row does not have a description</li>
	 *            </ul>
	 */
	 ...
	 *            <ul>
	 *            <li>[out] accessible - an accessible object representing the
	 *            row header, or null if there is no row header</li>
	 *            </ul>
	 */
	 ...
	 *            <ul>
	 *            <li>[out] accessibles - an array of accessible objects
	 *            representing row header cells, or null if there are no row
	 *            header cells</li>
	 *            </ul>
	 */
	 ...
	 *            <ul>
	 *            <li>[out] accessibles - an array of accessible objects
	 *            representing rows, or null if there are no rows</li>
	 *            </ul>
	 */
	 ...
	 *            an event object containing the following fields:
	 *            <ul>
	 *            <li>[out] accessibles - array containing the selected
	 *            accessible cells</li>
	 *            </ul>
	 */
	 ...
	 *            an event object containing the following fields:
	 *            <ul>
	 *            <li>[out] selected - an array of 0 based column indexes of
	 *            selected columns</li>
	 *            </ul>
	 */
	 ...
	 *            an event object containing the following fields:
	 *            <ul>
	 *            <li>[out] selected - an array of 0 based row indexes of
	 *            selected rows</li>
	 *            </ul>
	 */
	 ...
	 *            an event object containing the following fields:
	 *            <ul>
	 *            <li>[out] accessible - the summary for the table, or null if
	 *            the table does not have a summary</li>
	 *            </ul>
	 */
	 ...
	 *            <ul>
	 *            <li>[out] accessibles - an array of accessible objects
	 *            representing visible columns, or null if there are no visible
	 *            columns</li>
	 *            </ul>
	 */
	 ...
	 *            <ul>
	 *            <li>[out] accessibles - an array of accessible objects
	 *            representing visible rows, or null if there are no visible
	 *            rows</li>
	 *            </ul>
	 */
	 ...
	 *            an event object containing the following fields:
	 *            <ul>
	 *            <li>[in] column - 0 based index of the column for which to
	 *            determine whether it is selected</li>
	 *            <li>[out] isSelected - true if the specified column is
	 *            selected completely, and false otherwise</li>
	 *            </ul>
	 */
	 ...
	 *            an event object containing the following fields:
	 *            <ul>
	 *            <li>[in] row - 0 based index of the row for which to determine
	 *            whether it is selected</li>
	 *            <li>[out] isSelected - true if the specified row is selected
	 *            completely, and false otherwise</li>
	 *            </ul>
	 */
