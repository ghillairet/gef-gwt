...
public class ACC {
	...
	/**
	 * Scroll the top left corner of the object or substring to the specified
	 * point.
	 * 
	 * @since 3.6
	 */
	...
	/**
	 * Send when an object's state has changed, for example enabled/disabled,
	 * pressed/released, or checked/unchecked.
	 * <p>
	 ...
	 * <li>newValue - either 1 or 0, indicating whether the state has changed to
	 * true or false</li>
	 * </ul>
	 * </p>
	 * 
	...
	/**
	 * Send when a slide changed in a presentation document or a page boundary
	 * was crossed in a word processing document.
	 * 
	 * @since 3.6
	 */
	...
	/**
	 * Send when the count or attributes of an accessible object's actions have
	 * changed.
	 * 
	 * @since 3.6
	 */
	...
	/**
	 * Send when the starting index of this link within the containing string
	 * has changed.
	 * 
	 * @since 3.6
	 */
	...
	/**
	 * Send when the ending index of this link within the containing string has
	 * changed.
	 * 
	 * @since 3.6
	 */
	...
	/**
	 * Send when the number of anchors associated with this hyperlink object has
	 * changed.
	 * 
	 * @since 3.6
	 */
	...
	/**
	 * Send when the hyperlink selected state changed from selected to
	 * unselected or from unselected to selected.
	 * 
	 * @since 3.6
	 */
	...
	/**
	 * Send when one of the links associated with the hypertext object has been
	 * selected.
	 * <p>
	 * The eventData object is an Integer that represents the index of the
	 * selected link in the hypertext object.
	 * </p>
	 * 
	 * @since 3.6
	 */
	...
	/**
	 * Send when the number of hyperlinks associated with a hypertext object has
	 * changed.
	 * 
	 * @since 3.6
	 */
	 ...
	 * <li>rowCount - the number of contiguous rows that changed, or 0 if no
	 * rows changed</li>
	 * <li>columnStart - the index of the first column that changed</li>
	 * <li>columnCount - the number of contiguous columns that changed, or 0 if
	 * no columns changed</li>
	 * </ul>
	 * </p>
	 * 
	 * @since 3.6
	...
	/**
	 * This object is interactive and controls some attribute of a target
	 * object.
	 * 
	 * @since 3.6
	 */
	...
	/**
	 * Content flows to this object from a target object. This relation and
	 * RELATION_FLOWS_TO are useful to tie text and non-text objects together in
	 * order to allow assistive technology to follow the intended reading order.
	 * 
	 * @since 3.6
	 */
	 ...
	 * multiple additional targets, e.g. one for every other member in the
	 * group.
	 * 
	 * @since 3.6
	 */
