 ...
 * be added to a control using the <code>addAccessibleTextListener</code> method
 * and removed using the <code>removeAccessibleTextListener</code> method. When
 * a client requests information the appropriate method will be invoked.
 * </p>
 * <p>
