 ...
 * AccessibleTableCell events.
 * <p>
 * After creating an instance of a class that implements this interface it can
 * be added to an accessible using the
 * <code>addAccessibleTableCellListener</code> method and removed using the
 * <code>removeAccessibleTableCellListener</code> method.
 * </p>
 * 
...
public interface AccessibleTableCellListener extends SWTEventListener {
	 ...
	 * <p>
	 * This is 1 if the specified cell is only in one column, or more than 1 if
	 ...
	 *            <ul>
	 *            <li>[out] count - the 1 based number of columns spanned by the
	 *            specified cell
	 *            </ul>
	 */
	...
	/**
	 * Returns the column headers as an array of cell accessibles. TODO: doc
	 * that this is a more efficient way to get headers of a cell than
	 * TableListener.getRow/ColHeaders
	 * 
	 * @param e
	 *            an event object containing the following fields:
	 *            <ul>
	 *            <li>[out] accessibles - an array of cell accessibles, or null
	 ...
	 *            an event object containing the following fields:
	 *            <ul>
	 *            <li>[out] index - the 0 based column index of the specified
	 *            cell, or the index of the first column if the cell spans
	 *            multiple columns
	 *            </ul>
	 */
	 ...
	 * <p>
	 * This is 1 if the specified cell is only in one row, or more than 1 if the
	 ...
	 *            an event object containing the following fields:
	 *            <ul>
	 *            <li>[out] count - the 1 based number of rows spanned by the
	 *            specified cell
	 *            </ul>
	 */
	...
	/**
	 * Returns the row headers as an array of cell accessibles. TODO: doc that
	 * this is a more efficient way to get headers of a cell than
	 * TableListener.getRow/ColHeaders
	 * 
	 * @param e
	 *            an event object containing the following fields:
	 ...
	 *            an event object containing the following fields:
	 *            <ul>
	 *            <li>[out] isSelected - true if the specified cell is selected
	 *            and false otherwise
	 *            </ul>
	 */
