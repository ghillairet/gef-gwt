 ...
 * AccessibleHyperlink messages to an accessible object.
 * 
...
public class AccessibleHyperlinkEvent extends SWTEventObject {
	...
	/**
	 * The value of this field must be set in the accessible hyperlink listener
	 * method before returning. What to set it to depends on the listener method
	 * called.
	 */
