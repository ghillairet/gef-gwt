 ...
 * by the <code>AccessibleTextListener</code> interface.
 * <p>
 * Classes that wish to deal with <code>AccessibleTextEvent</code>s can extend
 * this class and override only the methods that they are interested in.
 * </p>
 * <p>
...
public abstract class AccessibleTextAdapter implements AccessibleTextListener {
	 ...
	 * of the text caret. The default behavior is to do nothing.
	 * <p>
	 * Return the caret offset in the <code>offset</code> field of the event
	 * object.
	 * </p>
	 * 
	 * @param e
	...
	/**
	 * Sent when an accessibility client requests the range of the current text
	 * selection. The default behavior is to do nothing.
	 * <p>
