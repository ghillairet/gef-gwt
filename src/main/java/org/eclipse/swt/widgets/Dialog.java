 ...
 * in platform dialogs. A <code>Dialog</code> typically contains other widgets
 * that are not accessible. A <code>Dialog</code> is not a <code>Widget</code>.
 * <p>
 ...
 * </code>
 * <p>
 * Note: The <em>modality</em> styles supported by this class are treated as
 * <em>HINT</em>s, because not all are supported by every subclass on every
 ...
 * <code>PRIMARY_MODAL</code> is not supported by a particular dialog, it would
 * be upgraded to <code>APPLICATION_MODAL</code>. In addition, as is the case
...
public abstract class Dialog {
	...
	/**
	 * Returns the receiver's parent, which must be a <code>Shell</code> or
	 * null.
	 * 
