...
public class DragSourceEvent extends TypedEvent {
	 ...
	 * application can set this value to false to prevent the drag from
	 * starting. Set to true by default.
	 * </p>
	 * <p>
	 * In dragSetData:
	 * </p>
	...
	/**
	 * The type of data requested. Data provided in the data field must be of
	 * the same type.
	 */
	...
	public String toString() {
		...
		return string.substring(0, string.length() - 1) // remove trailing '}'
				+ " operation=" + detail
				+ " type="
				+ (dataType != null ? dataType.type : 0) + " doit="
				+ doit
				+ "}";
	}
}
