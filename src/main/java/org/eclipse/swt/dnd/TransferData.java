...
public class TransferData {
	...
	/**
	 * Specifies the number of units in pValue. (Warning: This field is platform
	 * dependent)
	 * <p>
	 * <b>IMPORTANT:</b> This field is <em>not</em> part of the SWT public API.
	 * It is marked public only so that it can be shared within the packages
	...
	/**
	 * Specifies the size in bits of a single unit in pValue. (Warning: This
	...
	/**
	 * Pointer to the data being transferred. (Warning: This field is platform
	 * dependent)
	 * <p>
	 * <b>IMPORTANT:</b> This field is <em>not</em> part of the SWT public API.
	 * It is marked public only so that it can be shared within the packages
