 ...
 * by the <code>MouseListener</code> interface.
 * <p>
 * Classes that wish to deal with <code>MouseEvent</code>s which occur as mouse
 * buttons are pressed and released can extend this class and override only the
...
public abstract class MouseAdapter implements MouseListener {
	 ...
	 * specified) double click period. The default behavior is to do nothing.
	 * 
	 * @param e
	...
	/**
	 * Sent when a mouse button is pressed. The default behavior is to do
	 * nothing.
	 * 
	 * @param e
	...
	/**
	 * Sent when a mouse button is released. The default behavior is to do
	 * nothing.
	 * 
	 * @param e
