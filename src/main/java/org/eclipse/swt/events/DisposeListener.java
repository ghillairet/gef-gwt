 ...
 * be added to a widget using the <code>addDisposeListener</code> method and
 * removed using the <code>removeDisposeListener</code> method. When a widget is
 * disposed, the widgetDisposed method will be invoked.
 * </p>
 * 
 * @see DisposeEvent
 */
