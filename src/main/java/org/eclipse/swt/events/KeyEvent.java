...
public class KeyEvent extends TypedEvent {
	 ...
	 * example, when the user types Ctrl+A, the character value is 0x01. It is
	 * important that applications do not attempt to modify the character value
	 * based on a stateMask (such as SWT.CTRL) or the resulting character will
	 * not be correct.
	 */
	 ...
	 * constants in class <code>SWT</code>. When the character field of the
	 * event is ambiguous, this field contains the unicode value of the original
	 ...
	 * same key code and character but are generated by different keys on the
	 * keyboard. For example, a key down event with the key code equal to
	 * SWT.SHIFT can be generated by the left and the right shift keys on the
	 * keyboard.
	 * </p>
	 * <p>
	 * The location field can only be used to determine the location of the key
	 * code or character in the current event. It does not include information
	 * about the location of modifiers in the state mask.
	 * </p>
	 * 
