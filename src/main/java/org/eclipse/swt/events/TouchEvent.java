...
/**
 * Instances of this class are sent in response to a touch-based input source
 * being touched.
 * 
 * @see TouchListener
...
public class TouchEvent extends TypedEvent {
	...
	/**
	 * The set of touches representing the state of all contacts with touch
	 * input device at the time the event was generated.
	 * 
	...
	/**
	 * The widget-relative x coordinate of the pointer at the time the touch
	 * occurred.
	 */
	public int x;

	/**
	 * The widget-relative y coordinate of the pointer at the time the touch
	 * occurred.
	 */
	public int y;
	...
	public String toString() {
		...
		string = string.substring(0, string.length() - 1); // remove trailing
															// '}'
		string += " stateMask=" + stateMask + " x=" + x + " y=" + y;
		if (touches != null) {
