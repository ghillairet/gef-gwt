 ...
 * <code>addMenuDetectListener</code> method and removed using the
 * <code>removeMenuDetectListener</code> method. When the context menu trigger
 * occurs, the <code>menuDetected</code> method will be invoked.
 * </p>
 * 
 * @see MenuDetectEvent
 * 
...
public interface MenuDetectListener extends SWTEventListener {
	 ...
	 * 
	 * @param e
	 *            an event containing information about the menu detect
	 */
