 ...
 * by the <code>ShellListener</code> interface.
 * <p>
 * Classes that wish to deal with <code>ShellEvent</code>s can extend this class
...
public abstract class ShellAdapter implements ShellListener {
	...
	/**
	 * Sent when a shell becomes the active window. The default behavior is to
	 * do nothing.
	 * 
	 * @param e
	...
	/**
	 * Sent when a shell stops being the active window. The default behavior is
	 * to do nothing.
	 * 
	 * @param e
