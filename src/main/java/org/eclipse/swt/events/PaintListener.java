 ...
 * be added to a control using the <code>addPaintListener</code> method and
 * removed using the <code>removePaintListener</code> method. When a paint event
 * occurs, the paintControl method will be invoked.
 * </p>
 * 
 * @see PaintEvent
 */
