 ...
 * be added to a control using the <code>addTraverseListener</code> method and
 * removed using the <code>removeTraverseListener</code> method. When a traverse
 * event occurs in a control, the keyTraversed method will be invoked.
 * </p>
 * 
 * @see TraverseEvent
 */
public interface TraverseListener extends SWTEventListener {
	 ...
	 * <code>TRAVERSE_</code> are defined in the <code>SWT</code> class.
	 * </p>
	 * 
	 * @param e
