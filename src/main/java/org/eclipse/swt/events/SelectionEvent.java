...
public class SelectionEvent extends TypedEvent {
	...
	/**
	 * The text of the hyperlink that was selected. This will be either the text
	 * of the hyperlink or the value of its HREF, if one was specified.
	 * 
	 ...
	 * field to <code>false</code> will cancel the operation, depending on the
	 * widget.
	 */
	public boolean doit;
	...
	public String toString() {
		...
		return string.substring(0, string.length() - 1) // remove trailing '}'
				+ " item=" + item + " detail=" + detail + " x=" + x + " y="
				+ y
				+ " width=" + width + " height=" + height
				+ " stateMask="
				+ stateMask + " text=" + text + " doit=" + doit + "}";
	}
}
