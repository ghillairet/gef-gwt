 ...
 * </p>
 * <p>
 * <code>FormData</code> contains the <code>FormAttachments</code> for each edge
 * of the control that the <code>FormLayout</code> uses to determine the size
 * and position of the control. <code>FormData</code> objects also allow you to
 * set the width and height of controls within a <code>FormLayout</code>.
 * </p>
 * 
 * @see FormLayout
 * @see FormAttachment
...
public final class FormData {
	...
	FormAttachment getBottomAttachment(Control control, int spacing,
			boolean flushCache) {
		if (cacheBottom != null)
			return cacheBottom;
		if (isVisited)
	...
	FormAttachment getLeftAttachment(Control control, int spacing,
			boolean flushCache) {
		if (cacheLeft != null)
			return cacheLeft;
		if (isVisited)
	...
	FormAttachment getRightAttachment(Control control, int spacing,
			boolean flushCache) {
		if (cacheRight != null)
			return cacheRight;
		if (isVisited)
	...
	FormAttachment getTopAttachment(Control control, int spacing,
			boolean flushCache) {
		if (cacheTop != null)
			return cacheTop;
		if (isVisited)
