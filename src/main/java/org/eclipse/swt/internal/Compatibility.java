...
/**
 * This class is a placeholder for utility methods commonly used on J2SE
 * platforms but not supported on some J2ME profiles.
 * <p>
 * It is part of our effort to provide support for both J2SE and J2ME platforms.
 * </p>
 * <p>
 * IMPORTANT: some of the methods have been modified from their J2SE parents.
 * Refer to the description of each method for specific changes.
 * </p>
 * <ul>
 * <li>Exceptions thrown may differ since J2ME's set of exceptions is a subset
 * of J2SE's one.</li>
 * <li>The range of the mathematic functions is subject to change.</li>
 * </ul>
 */
public final class Compatibility {
	 ...
	 * triangle. In other words, it returns the integer conversion of length *
	 * cos (angle).
	 * <p>
	 * IMPORTANT: the j2me version has an additional restriction on the
	 * argument. length must be between -32767 and 32767 (inclusive).
	 * </p>
	 * 
	 * @param angle
	...
	/**
	 * Answers the most negative (i.e. closest to negative infinity) integer
	 * value which is greater than the number obtained by dividing the first
	 * argument p by the second argument q.
	 * 
	 * @param p
	 *            numerator
	 * @param q
	...
	/**
	 * Answers the most positive (i.e. closest to positive infinity) integer
	 * value which is less than the number obtained by dividing the first
	 * argument p by the second argument q.
	 * 
	 * @param p
	 *            numerator
	 ...
	 * <p>
	 * IMPORTANT: the j2me version has an additional restriction on the
	 * arguments. p must be within the range 0 - 32767 (inclusive). q must be
	 * within the range 1 - 32767 (inclusive).
	 * </p>
	 * 
	 * @param p
	 *            numerator
	 ...
	 *                <ul>
	 *                <li>ERROR_INVALID_RANGE - if the argument is not between 0
	 *                and 30 (inclusive)</li>
	 *                </ul>
	 */
	...
	/**
	 * Execute a program in a separate platform process if the underlying
	...
	/**
	 * Execute progArray[0] in a separate platform process if the underlying
	 * platform support this.
	 * <p>
	 * The new process inherits the environment of the caller.
	 * <p>
	...
	/**
	 * Execute prog[0] in a separate platform process if the underlying platform
	 * supports this.
	 * <p>
	 * The new process inherits the environment of the caller.
	 * <p>
	...
	public static void exec(String[] prog, String[] envp, String workingDir)
		...
		// Runtime.getRuntime().exec(prog, null,
	...
	public static String getMessage(String key) {
		...
		// try {
		// msgs = ResourceBundle
		//						.getBundle("org.eclipse.swt.internal.SWTMessages"); //$NON-NLS-1$
