...
public interface Preferences {
	 ...
	 *             {@link #removeNode()} method.
	 * @throws NullPointerException
	 *             if {@code key} is {@code null}. (A {@code null} default <i>is
	 *             </i> permitted.)
	 */
	 ...
	 * @param value
	 *            {@code value} whose string form is to be associated with
	 *            {@code key}.
	 * @throws NullPointerException
	 ...
	 * 
	 * @param key
	 *            key whose associated value is to be returned as an {@code int}
	 *            .
	 * @param def
	 *            the value to be returned in the event that this node has no
	 *            value associated with {@code key} or the associated value
	 *            cannot be interpreted as an {@code int} or the backing store
	 *            is inaccessible.
	 ...
	 * method is intended for use in conjunction with the {@link #getLong}
	 * method.
	 * 
	 * <p>
	 ...
	 * 
	 * @param key
	 *            {@code key} with which the string form of {@code value} is to
	 *            be associated.
	 * @param value
	 *            {@code value} whose string form is to be associated with
	 *            {@code key}.
	 ...
	 * 
	 * @param key
	 *            {@code key} whose associated value is to be returned as a
	 *            {@code long} value.
	 * @param def
	 *            the value to be returned in the event that this node has no
	 *            value associated with {@code key} or the associated value
	 ...
	 * 
	 * @param key
	 *            {@code key} with which the string form of value is to be
	 *            associated.
	 * @param value
	 *            value whose string form is to be associated with {@code key}.
	 * @throws NullPointerException
	 *             if {@code key} is {@code null}.
	 * @throws IllegalStateException
	 *             if this node (or an ancestor) has been removed with the
	 ...
	 * with the {@link #putBoolean} method.
	 * 
	 * <p>
	 * Returns the specified default if there is no value associated with the
	 ...
	 *            the value to be returned in the event that this node has no
	 *            value associated with {@code key} or the associated value
	 *            cannot be interpreted as a {@code boolean} or the backing
	 *            store is inaccessible.
	 ...
	 * method is intended for use in conjunction with the {@link #getFloat}
	 * method.
	 * 
	 * <p>
	 * Implementor's note: it is <i>not </i> necessary that the value be
	 ...
	 * method is intended for use in conjunction with the {@link #putFloat}
	 * method.
	 * 
	 * @param key
	 *            {@code key} whose associated value is to be returned as a
	 ...
	 * method is intended for use in conjunction with the {@link #getDouble}
	 * method
	 * 
	 * <p>
	 * Implementor's note: it is <i>not </i> necessary that the value be
	 ...
	 *         {@code double} type.
	 * @throws IllegalStateException
	 *             if this node (or an ancestor) has been removed with the the
	 *             {@link #removeNode()} method.
	 * @throws NullPointerException
	 *             if {@code key} is {@code null}.
	 ...
	 * with the {@link #putByteArray} method.
	 * 
	 * <p>
	 * Returns the specified default if there is no value associated with the
	 * {@code key}, the backing store is inaccessible, or if the associated
	 ...
	 *         {@code byte[]}.
	 * @throws NullPointerException
	 *             if {@code key} is {@code null}. (A {@code null} value for
	 *             {@code def} <i>is </i> permitted.)
	 * @throws IllegalStateException
	 *             if this node (or an ancestor) has been removed with the
	 *             {@link #removeNode()} method.
	 * @see #get(String,String)
	 ...
	 * 
	 * @param pathName
	 *            the path name of the {@code Preferences} object to return.
	 ...
	 * @throws IllegalStateException
	 *             if this node (or an ancestor) has been removed with the
	 *             {@link #removeNode()} method and {@code pathname} is not the
	 *             empty string ({@code ""}).
	 * @throws IllegalArgumentException
