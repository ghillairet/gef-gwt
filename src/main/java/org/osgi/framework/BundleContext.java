...
public interface BundleContext extends BundleReference {
	...
	// *
	// * <p>
	// * If the specified {@code InputStream} is {@code null}, the Framework
	// must
	...
	// *
	// * <p>
	// * The specified {@code location} identifier will be used as the identity
	// of
	...
	// *
	// * <li>The bundle's content is read from the input stream. If this fails,
	// a
	...
	// * @param input
	// * The {@code InputStream} object from which this bundle will be
	// * read or {@code null} to indicate the Framework must create the
	// * input stream from the specified location identifier. The input
	// * stream must always be closed when this method completes, even
	// * if an exception is thrown.
	// * @return The {@code Bundle} object of the installed bundle.
	// * @throws BundleException
	// * If the installation failed. BundleException types thrown by
	// * this method include: {@link BundleException#READ_ERROR} ,
	...
	// * {@code l} such that {@code (l==listener)}, then this method replaces
	// that
	...
	// * {@link Constants#OBJECTCLASS} property. If {@code filter} is {@code
	// null}
	// * , all services are considered to match the filter.
	// *
	// * <p>
	// * When using a {@code filter}, it is possible that the {@code
	// ServiceEvent}
	...
	// * setting property {@code x} to the value {@code 1}, the filter will
	// match
	...
	// * if the bundle that is registering it has the {@code ServicePermission}
	// to
	...
	// * If {@code filter} contains an invalid filter string that
	// * cannot be parsed.
	// * @throws IllegalStateException
	// * If this BundleContext is no longer valid.
	// * @see ServiceEvent
	...
	// * If this BundleContext is no longer valid.
	// * @throws SecurityException
	// * If listener is a {@code SynchronousBundleListener} and the
	...
	// * bundle's list of listeners if not already present. FrameworkListeners
	// are
	...
	// The
	// * registering bundle is defined to be the context bundle. Other bundles
	// can
	...
	// *
	// * @param clazzes
	// * The class names under which the service can be located. The
	...
	// * object must all be {@code String} objects. See
	...
	// * called. The set of properties may be {@code null} if the
	...
	// * <ul>
	// * <li>{@code service} is {@code null}. <li>{@code service} is
	// * not a {@code ServiceFactory} object and is not an instance of
	// * all the named classes in {@code clazzes}. <li>
	// * {@code properties} contains case variants of the same key
	// * name.
	// * </ul>
	// * @throws SecurityException
	// * If the caller does not have the {@code ServicePermission} to
	// * register the service for all the named classes and the Java
	// * Runtime Environment supports permissions.
	// * @throws IllegalStateException
	// * If this BundleContext is no longer valid.
	...
	// * @see ServiceFactory
	// */
	// // ServiceRegistration<?> registerService(String[] clazzes, Object
	// service,
	...
	// * {@link #registerService(String[], Object, Dictionary)} and is provided
	// as
	...
	// * {@link Constants#OBJECTCLASS} property will be an array of string,
	// rather
	...
	// * expression, and the packages for the class names under which the
	// services
	...
	// * the filter expression. See {@link Filter} for a description of the
	// filter
	...
	// * <ul>
	// * <li>If the specified class name, {@code clazz}, is not {@code null},
	// the
	...
	// * <li>If the Java Runtime Environment supports permissions, the caller
	// must
	...
	// * @since 1.3
	// */
	// ServiceReference<?>[] getAllServiceReferences(String clazz, String
	// filter)
	// throws InvalidSyntaxException;
	//
	// /**
	...
	// * @return A {@code ServiceReference} object, or {@code null} if no
	// services
	...
	// * Type of Service
	// * @param clazz
	// * The class name with which the service was registered. Must not
	// * be {@code null}.
	// * @param filter
	// * The filter expression or {@code null} for all services.
	// * @return A collection of {@code ServiceReference} objects. May be empty
	// if
	// * no services are registered which satisfy the search.
	// * @throws InvalidSyntaxException
	// * If the specified {@code filter} contains an invalid filter
	...
	// * <p>
	// * A bundle's use of a service is tracked by the bundle's use count of
	// that
	// * service. Each time a service's service object is returned by
	// * {@link #getService(ServiceReference)} the context bundle's use count
	// for
	...
	// is
	// * called to create a service object for the context bundle. If the
	// service
	// * object returned by the {@code ServiceFactory} object is {@code null},
	// not
	...
	// * @throws SecurityException
	// * If the caller does not have the {@code ServicePermission} to
	// * get the service using at least one of the named classes the
	// * service was registered under and the Java Runtime Environment
	// * supports permissions.
	// * @throws IllegalStateException
	// * If this BundleContext is no longer valid.
	// * @throws IllegalArgumentException
	// * If the specified {@code ServiceReference} was not created by
	// * the same framework instance as this {@code BundleContext}.
	...
	// *
	// * <p>
	// * The service's service object should no longer be used and all
	// references
	...
	// the
	// * {@link ServiceFactory#ungetService(Bundle, ServiceRegistration,
	// Object)}
	...
	// * area provided for the context bundle by the Framework can be obtained
	// by
	...
	// *
	// * <p>
	// * If the filter cannot be parsed, an {@link InvalidSyntaxException} will
	// be
	// * thrown with a human readable message where the filter became
	// unparsable.
	// *
	// * @param filter
	// * The filter string.
	...
	// * @return A {@code Bundle} object or {@code null} if the location does
	// not
