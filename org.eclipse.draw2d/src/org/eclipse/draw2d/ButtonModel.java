...
public class ButtonModel {
	...
	class RepeatFiringBehavior extends ButtonStateTransitionListener {
		...
		private void startTimer() {
			...
			Display.getDefault().timerExec(initialDelay, new Runnable() {

				public void run() {
					if (isEnabled() && !timerCancelled) {
						fireActionPerformed();
						scheduleNextTimeout();
					}
				}
		...
		protected void scheduleNextTimeout() {
			Display.getDefault().timerExec(stepDelay, new Runnable() {
