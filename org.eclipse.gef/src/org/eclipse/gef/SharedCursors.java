...
public class SharedCursors extends Cursors {
	...
	static {
		...
		CURSOR_PLUG = BrowserCursorSupport.INSTANCE.createPlug();
		//		CURSOR_PLUG_NOT = createCursor("icons/plugmasknot.gif", //$NON-NLS-1$
		//				"icons/plugnot.bmp"); //$NON-NLS-1$
		CURSOR_PLUG_NOT = BrowserCursorSupport.INSTANCE.createPlugNot();
		...
		CURSOR_TREE_ADD = BrowserCursorSupport.INSTANCE.createTreeAdd();
