...
public abstract class Reference<T> {
	...
	// enqueued
	// * by the Reference-handler thread. Unregistered instances are never in
	// this
	// * state.
	// *
	// * Enqueued: An element of the queue with which the instance was
	// registered
	// * when it was created. When an instance is removed from its
	// ReferenceQueue,
	...
	// *
	// * With this scheme the collector need only examine the next field in
	// order
	// * to determine whether a Reference instance requires special treatment:
	// If
	...
	// objects
	// * without interfering with application threads that may apply the
	// enqueue()
	// * method to those objects, collectors should link discovered objects
	// * through the discovered field.
	// */
	//
	...
	// References
	// * to this list, while the Reference-handler thread removes them. This
	// list
	// * is protected by the above lock object.
	// */
