 ...
 * @since 3.2
 */
public class TreeSelection extends StructuredSelection implements
		ITreeSelection {
	 ...
	 *            tree paths
	 * @param comparer
	 *            the comparer, or <code>null</code> if default equals is to be
	 *            used
	 */
	...
	public TreeSelection(TreePath treePath) {
		this(treePath != null ? new TreePath[] { treePath } : EMPTY_TREE_PATHS,
				null);
	}
	...
	public TreePath[] getPaths() {
		Object[] clone = new Object[paths.length];
		System.arraycopy(paths, 0, clone, 0, paths.length);
		return paths == null ? EMPTY_TREE_PATHS : (TreePath[]) clone;
	}
