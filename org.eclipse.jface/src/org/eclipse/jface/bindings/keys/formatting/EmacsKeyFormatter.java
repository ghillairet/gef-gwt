...
public final class EmacsKeyFormatter extends AbstractKeyFormatter {
	 ...
	 * 
	 * @see
	 * org.eclipse.jface.bindings.keys.AbstractKeyFormatter#getKeyDelimiter()
	 */
	protected String getKeyDelimiter() {
		// return Util.translateString(RESOURCE_BUNDLE, KEY_DELIMITER_KEY,
		// KeyStroke.KEY_DELIMITER);
		return "Emacskeyformatter";
	}
	 ...
	 * 
	 * @see
	 * org.eclipse.jface.bindings.keys.AbstractKeyFormatter#getKeyStrokeDelimiter
	 * ()
	 */
	 ...
	 * 
	 * @see
	 * org.eclipse.jface.bindings.keys.AbstractKeyFormatter#sortModifierKeys
	 * (int)
	 */
