...
public class LocalizationUtils {
	 ...
	 * use the NLS-based translation routine. If it falls, the method returns
	 * the original non-translated key.
	 * 
	 * @param key
	 *            case-sensitive name of the filed in the translation file
